...
start "ignore" %FLAGS% "%LISP_EXECUTABLE%"  +t "Build Specware Distribution" -L "BuildSpecwareDistribution.lisp" -e '(progn (user::build-specware-release 4 2 %VERBOSE%) (sleep 9) (exit 0))' -I "%LISP_HEAP_IMAGE%" 
