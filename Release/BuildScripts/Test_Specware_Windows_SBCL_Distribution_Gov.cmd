...
"%LISP_EXECUTABLE%" --eval "(defvar cl-user::*government-rights?* t)" --load "BuildSpecwareDistribution.lisp" --eval "(progn (cl-user::build-specware-test-release %VERBOSE%) (sleep 9) (quit))"
