...
start "ignore" %LISP_EXECUTABLE%  +t "Specware Shell" -I
"%LISP_HEAP_IMAGE%" -e "(progn (Specware::initializeSpecware-0) (setq emacs::*use-emacs-interface?* nil) (SWShell::sw-shell-0))"
