...
(defun SPECCALC::snarkBaseSort (s rng?) 
  (block 
   nil 
   (if (eq (car s) :|Base|) 
       (let ((pV18 (svref (cdr s) 0))) 
         (if (eq (car pV18) :|Qualified|) 
             (let ((pV21 (cdr pV18))) 
               (let ((pV23 (cdr pV21))
                     (pV22 (car pV21))) 
                 (progn (if (string=  "Nat" pV22) 
                            (if (string=  "Nat" pV23) 
                                (return (LISP-SPEC::|!symbol| "SNARK" "NATURAL"))) 
                            (if (string=  "Integer" pV22) 
                                (if (string=  "Integer" pV23) 
                                    (return 
                                     (LISP-SPEC::|!symbol| "SNARK" "INTEGER"))) 
                                (if (string=  "Boolean" pV22) 
                                    (if (string=  "Boolean" pV23) 
                                        (return 
                                         (LISP-SPEC::|!symbol| "SNARK" "BOOLEAN")))))) 
                        (return 
                         (if rng? 
                             (LISP-SPEC::|!symbol| "SNARK" pV23) 
                             (LISP-SPEC::|!symbol| "SNARK" pV23)))))))) 
       (if (eq (car s) :|Product|) 
                 ...
                 (return 
                  (let ((snarkArgs 
                    ...
                    (LISP-SPEC::|!cons| 
                     (LISP-SPEC::|!symbol| 
                      "SNARK" 
                      (SPECCALC::mkSnarkName (car pV14) (cdr pV14))) 
...
(defun SPECCALC::snarkFunctionDecl (spc name srt) 
  (let ((pV10 (ARITYNORMALIZE::sortArity spc srt))
        (pV9 (SPECTOLISP::curryShapeNum spc srt))) 
    (block 
     nil 
     (if ( =  1 pV9) 
         (if (eq (car pV10) :|None|) 
     ...
     (if (eq (car pV10) :|None|) 
         ...
         (if (eq (car pV10) :|Some|) (return (SPECCALC::snarkFunctionCurryDecl)))) 
     (return (SPECCALC::snarkFunctionNoArityDecl spc name srt)))))
