...
"%XEMACS_EXE%" -l "%SPECWARE4%\Library\IO\Emacs\xeli\fi-site-init" -l "%SPECWARE4%\Library\IO\Emacs\load" -f run-lisp-application -l "%SPECWARE4%\Library\IO\Emacs\load-ansi-loop"
