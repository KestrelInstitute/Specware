...
if exist Specware-4-2-2 ( cd Specware-4-2-2 )
...
start "ignore" %MAYBE_WAIT% "%XEMACS_EXE%" -l "%SPECWARE4%\Library\IO\Emacs\Preface" -l "%SPECWARE4%\Library\IO\Emacs\xeli\fi-site-init" -l "%SPECWARE4%\Library\IO\Emacs\load" -f "%1"
