XML qualifying spec
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %%
  %% Warning:  The W3 documentation uses "document" or "XML document" sometimes to refer to a 
  %%           collection of entities (a document entity, an external DTD subset, and misc other 
  %%           entities), and sometimes to refer to the document entity in particular.
  %%
  ...
  sort XML_Document = {document : Document,           % document entity
		       external : Option ExtSubset,   % external dtd subset entity
