...
%op SCParser.mkTransformBool 	     (b     : Bool,                                     left : LCB, right : LCB) : TransformExpr = SpecCalc.mkTransformBool         (b,              mkRegion left right)
 ...
 op SCParser.mkTransformGlobalize    (typ   : MSType,        gvar     : GlobalVarName,  left : LCB, right : LCB) : TransformExpr = SpecCalc.mkTransformGlobalize    (typ,  gvar,     mkRegion left right)
