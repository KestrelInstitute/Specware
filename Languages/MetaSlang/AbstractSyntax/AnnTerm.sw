...
% op equalTerm?          : [a,b] ATerm    a * ATerm    b -> Bool
 ...
 op [accum,b] mapAccumTerm ((tsp as (term_map,_,_)) : (TSP_MapAccums (accum,b)))
                           (accum : accum)
                           (term : ATerm b) : (ATerm b * accum) =
   %%
...
*)
 ...
 op [b] mapType ((tsp as (_, type_map, _)) : TSP_Maps b) (ty :AType b) : AType b =
   let
