...
spec
  ...
  op MapBTV.BTV_inDomain? : fa(key,a) Map (key,a) * key -> Boolean
  op MapBTV.BTV_mapi : fa(key,a,b) (key * a -> b) * Map (key,a) -> Map (key,b)
  op MapBTV.BTV_map  : fa(key,a,b) (a -> b) * Map (key,a) -> Map (key,b)

  op MapBTV.BTV_mapPartial  : fa(key,a,b) (a -> Option b) * Map (key,a)
                                             -> Map (key,b)
  op MapBTV.BTV_mapiPartial : fa(key,a,b) (key * a -> Option b) * Map (key,a)
                                             -> Map (key,b)
