...
\begin{spec}
  op emptySystem : System
  def emptySystem = {
    shape = emptySketch,
    functor = emptyFunctor
  }

  op addVertex : System -> V.Elem -> System
  ...
  op vertexInSystem? : System -> V.Elem -> Boolean
  op edgeInSystem? : System -> E.Elem -> Boolean

  op labelVertex : System -> V.Elem -> Object -> System
  ...
  op labelEdge : System -> E.Elem -> Object -> Arrow -> Arrow -> System
...
\begin{spec}
  op edgeLabel : System -> E.Elem -> (Arrow * Object * Arrow)
  ...
  op vertexLabel : System -> V.Elem -> Object

  op foldOverEdges : fa (x) (x -> E.Elem -> x) -> x -> System -> x
  op foldOverVertices : fa (x) (x -> V.Elem -> x) -> x -> System -> x
\end{spec}

\begin{spec}
  op mapSystem : System -> (Object -> Object) -> (Arrow -> Arrow) -> System
