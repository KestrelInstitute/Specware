...
(******************************************************************************)
(* The translator doesn't get all the issues of subtyping yet                 *)
(* For now I need to replace the resulting Isabelle code by the following     *)
(* This code should disappear in the future                                   *)
(******************************************************************************)

theorem Bits__toNibbles_Obligation_subtype: 
  "Nat__posNat_p 4"
  by auto
theorem Bits__toNibbles_Obligation_subtype0: 
  "\<lbrakk>4 zdvd int (length bs)\<rbrakk> \<Longrightarrow> 4 zdvd int (length bs)"
  by auto
consts Bits__toNibbles :: "Bits__Bits \<Rightarrow> Bits__Nibbles"
defs Bits__toNibbles_def: 
  "Bits__toNibbles bs \<equiv> map Abs_Bits__Nibble (List__unflatten(bs, 4))"
theorem Bits__toBytes_Obligation_subtype: 
  "Nat__posNat_p 8"
  by auto
theorem Bits__toBytes_Obligation_subtype0: 
  "\<lbrakk>8 zdvd int (length bs)\<rbrakk> \<Longrightarrow> 8 zdvd int (length bs)"
  by auto
consts Bits__toBytes :: "Bits__Bits \<Rightarrow> Bits__Bytes"
defs Bits__toBytes_def: 
  "Bits__toBytes bs \<equiv>  map Abs_Bits__Byte (List__unflatten(bs, 8))"
theorem Bits__toWord16s_Obligation_subtype: 
  "Nat__posNat_p 16"
  by auto
theorem Bits__toWord16s_Obligation_subtype0: 
  "\<lbrakk>16 zdvd int (length bs)\<rbrakk> \<Longrightarrow> 
   16 zdvd int (length bs)"
  by auto
consts Bits__toWord16s :: "Bits__Bits \<Rightarrow> Bits__Word16s"
defs Bits__toWord16s_def: 
  "Bits__toWord16s bs \<equiv>  map Abs_Bits__Word16 (List__unflatten(bs, 16))"
theorem Bits__toWord32s_Obligation_subtype: 
  "Nat__posNat_p 32"
  by auto
theorem Bits__toWord32s_Obligation_subtype0: 
  "\<lbrakk>32 zdvd int (length bs)\<rbrakk> \<Longrightarrow> 
   32 zdvd int (length bs)"
  by auto
consts Bits__toWord32s :: "Bits__Bits \<Rightarrow> Bits__Word32s"
defs Bits__toWord32s_def: 
  "Bits__toWord32s bs \<equiv> map Abs_Bits__Word32 (List__unflatten(bs, 32))"
theorem Bits__toWord64s_Obligation_subtype: 
  "Nat__posNat_p 64"
  by auto
theorem Bits__toWord64s_Obligation_subtype0: 
  "\<lbrakk>64 zdvd int (length bs)\<rbrakk> \<Longrightarrow> 
   64 zdvd int (length bs)"
  by auto
consts Bits__toWord64s :: "Bits__Bits \<Rightarrow> Bits__Word64s"
defs Bits__toWord64s_def: 
  "Bits__toWord64s bs \<equiv> map Abs_Bits__Word64 (List__unflatten(bs, 64))"
(******************************************************************************)
...
proof Isa Bits__Bits_prop [simp]
