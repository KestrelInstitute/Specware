...
theorem FMap__e_cl_gt__stp_Obligation_subtype: 
  "\<lbrakk>FMap__FMap_P(P__b, \<lambda> ignore. True) m2; 
    FMap__FMap_P(\<lambda> ignore. True, P__b) m1\<rbrakk> \<Longrightarrow> 
   Relation__functional_p
      (Relation__e_cl_gt__stp P__b(FMap__fromFMap m1, FMap__fromFMap m2))"
   sorry
...
theorem FMap__o__stp_Obligation_subtype: 
  "\<lbrakk>FMap__FMap_P(\<lambda> ignore. True, P__b) m2; 
    FMap__FMap_P(P__b, \<lambda> ignore. True) m1\<rbrakk> \<Longrightarrow> 
   Relation__functional_p
      (Relation__o__stp P__b(FMap__fromFMap m1, FMap__fromFMap m2))"
   sorry
