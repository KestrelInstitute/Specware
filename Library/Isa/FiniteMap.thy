...
theorem FMap__domain__stp_Obligation_subtype: 
  "\<lbrakk>FMap__FMap_P(\<lambda> ignore. True, P__b) m; 
    \<forall>(x::('a \<times> 'b) set). 
      x = FMap__fromFMap m 
        \<longrightarrow> finite x 
              \<and> (Relation__functional_p__stp(\<lambda> ignore. True, P__b)
                    (RFun (\<lambda> (ignore1, (x1::'b)). P__b x1) x) 
               \<and> Set_P (\<lambda> (ignore1, (x1::'b)). P__b x1) x)\<rbrakk> \<Longrightarrow> 
   Set_P (\<lambda> (ignore1, (x1_1::'b)). P__b x1_1) (FMap__fromFMap m)"
  by auto
      ...
      x = FMap__fromFMap m 
        \<longrightarrow> finite x 
              \<and> (Relation__functional_p__stp(P__a, \<lambda> ignore. True)
                    (RFun (\<lambda> ((x0::'a), ignore2). P__a x0) x) 
               \<and> Set_P (\<lambda> ((x0::'a), ignore2). P__a x0) x)\<rbrakk> \<Longrightarrow> 
   Set_P (\<lambda> ((x0_1::'a), ignore2). P__a x0_1) (FMap__fromFMap m)"
  by auto
    ...
    \<forall>(x::('a \<times> 'b) set). 
      x = FMap__fromFMap m 
        \<longrightarrow> finite x 
              \<and> (Relation__functional_p__stp(\<lambda> ignore. True, P__b)
                    (RFun (\<lambda> (ignore1, (x1::'b)). P__b x1) x) 
               \<and> Set_P (\<lambda> (ignore1, (x1::'b)). P__b x1) x); 
    x_2 = FMap__fromFMap m\<rbrakk> \<Longrightarrow> 
   Relation__functional_p__stp(\<lambda> ignore. True, P__b)
      (RFun (\<lambda> (ignore1, (x1::'b)). P__b x1) x_2) 
     \<and> Set_P (\<lambda> (ignore1, (x1_1::'b)). P__b x1_1) x_2"
  by auto
...
theorem FMap__definedAt_Obligation_subtype: 
  "\<lbrakk>\<forall>(x:: ('a, 'b)Relation__Relation). 
      x = FMap__fromFMap m 
        \<longrightarrow> finite x \<and> Relation__functional_p x\<rbrakk> \<Longrightarrow> 
   Relation__functional_p (FMap__fromFMap m)"
  by auto
consts FMap__definedAt :: " ('a, 'b)FMap__FMap \<Rightarrow> 'a \<Rightarrow> bool"	(infixl "definedAt" 60)
defs FMap__definedAt_def: 
  "(m definedAt (x::'a)) \<equiv> (FMap__fromFMap m definedAt x)"
...
theorem FMap__undefinedAt_Obligation_subtype: 
  "\<lbrakk>\<forall>(x:: ('a, 'b)Relation__Relation). 
   ...
   Relation__functional_p (FMap__fromFMap m)"
  by auto
consts FMap__undefinedAt :: " ('a, 'b)FMap__FMap \<Rightarrow> 'a \<Rightarrow> bool"	(infixl "undefinedAt" 60)
defs FMap__undefinedAt_def: 
  "(m undefinedAt (x::'a)) \<equiv> (FMap__fromFMap m undefinedAt x)"
theorem FMap__e_at_Obligation_subtype: 
  "\<lbrakk>m definedAt (x::'a); 
    \<forall>(x_1:: ('a, 'b)Relation__Relation). 
      x_1 = FMap__fromFMap m 
        \<longrightarrow> finite x_1 \<and> Relation__functional_p x_1\<rbrakk> \<Longrightarrow> 
   Relation__functional_p (FMap__fromFMap m)"
  by auto
theorem FMap__e_at_Obligation_subtype0: 
  "\<lbrakk>m definedAt (x::'a); Relation__functional_p (FMap__fromFMap m)\<rbrakk> \<Longrightarrow> 
   FMap__fromFMap m definedAt x"
   sorry
consts e_at_fm :: " ('a, 'b)FMap__FMap \<Rightarrow> 'a \<Rightarrow> 'b"	(infixl "@'_fm" 70)
defs e_at_fm_def: "(m @_fm (x::'a)) \<equiv> (FMap__fromFMap m @ x)"
...
theorem FMap__e_at_at_Obligation_subtype: 
  "\<lbrakk>\<forall>(x:: ('a, 'b)Relation__Relation). 
   ...
   Relation__functional_p (FMap__fromFMap m)"
  by auto
consts FMap__e_at_at :: " ('a, 'b)FMap__FMap \<Rightarrow> 'a \<Rightarrow> 'b option"	(infixl "@@" 70)
defs FMap__e_at_at_def: 
  "(m @@ (x::'a)) \<equiv> (FMap__fromFMap m @@ x)"
...
theorem FMap__applys__stp_Obligation_subtype0: 
  "\<lbrakk>FSet__FSet_P P__a xS; 
    \<forall>(x_2::'a set). 
      x_2 = FSet__fromFSet xS 
        \<longrightarrow> Set__finite_p__stp P__a (RSet P__a x_2) 
              \<and> Set_P P__a x_2\<rbrakk> \<Longrightarrow> Set_P P__a (FSet__fromFSet xS)"
  by auto
...
theorem FMap__applyis__stp_Obligation_subtype0: 
  "\<lbrakk>FSet__FSet_P P__b yS; 
    \<forall>(x_2::'b set). 
      x_2 = FSet__fromFSet yS 
        \<longrightarrow> Set__finite_p__stp P__b (RSet P__b x_2) 
              \<and> Set_P P__b x_2\<rbrakk> \<Longrightarrow> Set_P P__b (FSet__fromFSet yS)"
  by auto
...
theorem FMap__id_Obligation_subtype: 
  "\<lbrakk>x = EndoRelation__idOver (FSet__fromFSet dom)\<rbrakk> \<Longrightarrow> 
   finite x \<and> Relation__functional_p x"
   sorry
      ...
      x = FMap__fromFMap m1 
        \<longrightarrow> finite x 
              \<and> (Relation__functional_p__stp(\<lambda> ignore. True, P__b)
                    (RFun (\<lambda> (ignore1, (x1::'b)). P__b x1) x) 
               \<and> Set_P (\<lambda> (ignore1, (x1::'b)). P__b x1) x)\<rbrakk> \<Longrightarrow> 
   Set_P (\<lambda> (ignore1, (x1_1::'b)). P__b x1_1) (FMap__fromFMap m1)"
  by auto
theorem FMap__e_cl_gt__stp_Obligation_subtype0: 
  "\<lbrakk>FMap__FMap_P(P__b, \<lambda> ignore. True) m2; 
    \<forall>(x_2::('b \<times> 'c) set). 
      x_2 = FMap__fromFMap m2 
        \<longrightarrow> finite x_2 
              \<and> (Relation__functional_p__stp(P__b, \<lambda> ignore. True)
                    (RFun (\<lambda> ((x0::'b), ignore2). P__b x0) x_2) 
               \<and> Set_P (\<lambda> ((x0::'b), ignore2). P__b x0) x_2)\<rbrakk> \<Longrightarrow> 
   Set_P (\<lambda> ((x0_1::'b), ignore2). P__b x0_1) (FMap__fromFMap m2)"
  by auto
theorem FMap__e_cl_gt__stp_Obligation_subtype1: 
  "\<lbrakk>FMap__FMap_P(P__b, \<lambda> ignore. True) m2; 
   ...
   finite x_4 \<and> Relation__functional_p x_4"
   sorry
...
theorem FMap__e_cl_gt_Obligation_subtype: 
  "\<lbrakk>x_2 = FMap__fromFMap m1 :> FMap__fromFMap m2\<rbrakk> \<Longrightarrow> 
   finite x_2 \<and> Relation__functional_p x_2"
   sorry
consts FMap__e_cl_gt :: " ('a, 'b)FMap__FMap \<Rightarrow> 
                          ('b, 'c)FMap__FMap \<Rightarrow>  ('a, 'c)FMap__FMap"	(infixl ":>" 64)
defs FMap__e_cl_gt_def: 
  "(m1 :> m2)
...
theorem FMap__o__stp_Obligation_subtype: 
  "\<lbrakk>FMap__FMap_P(P__b, \<lambda> ignore. True) m1; 
    \<forall>(x::('b \<times> 'c) set). 
      x = FMap__fromFMap m1 
        \<longrightarrow> finite x 
              \<and> (Relation__functional_p__stp(P__b, \<lambda> ignore. True)
                    (RFun (\<lambda> ((x0::'b), ignore2). P__b x0) x) 
               \<and> Set_P (\<lambda> ((x0::'b), ignore2). P__b x0) x)\<rbrakk> \<Longrightarrow> 
   Set_P (\<lambda> ((x0_1::'b), ignore2). P__b x0_1) (FMap__fromFMap m1)"
  by auto
theorem FMap__o__stp_Obligation_subtype0: 
  "\<lbrakk>FMap__FMap_P(\<lambda> ignore. True, P__b) m2; 
    \<forall>(x_2::('a \<times> 'b) set). 
      x_2 = FMap__fromFMap m2 
        \<longrightarrow> finite x_2 
              \<and> (Relation__functional_p__stp(\<lambda> ignore. True, P__b)
                    (RFun (\<lambda> (ignore1, (x1::'b)). P__b x1) x_2) 
               \<and> Set_P (\<lambda> (ignore1, (x1::'b)). P__b x1) x_2)\<rbrakk> \<Longrightarrow> 
   Set_P (\<lambda> (ignore1, (x1_1::'b)). P__b x1_1) (FMap__fromFMap m2)"
  by auto
...
theorem FMap__o_Obligation_subtype: 
  "\<lbrakk>x_2 = FMap__fromFMap m1 o_R FMap__fromFMap m2\<rbrakk> \<Longrightarrow> 
   finite x_2 \<and> Relation__functional_p x_2"
   sorry
      ...
      x = FMap__fromFMap m1 
        \<longrightarrow> finite x 
              \<and> (Relation__functional_p__stp(P__a, P__b)
                    (RFun
                        (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1) x) 
               \<and> Set_P
                    (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1) x)\<rbrakk> \<Longrightarrow> 
   Set_P (\<lambda> ((x0_1::'a), (x1_1::'b)). P__a x0_1 \<and> P__b x1_1)
      (FMap__fromFMap m1)"
  by auto
    ...
    \<forall>(x_2::('a \<times> 'b) set). 
      x_2 = FMap__fromFMap m2 
        \<longrightarrow> finite x_2 
              \<and> (Relation__functional_p__stp(P__a, P__b)
                    (RFun
                        (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1) x_2) 
               \<and> Set_P
                    (\<lambda> ((x0_2::'a), (x1_2::'b)). 
                       P__a x0_2 \<and> P__b x1_2) x_2)\<rbrakk> \<Longrightarrow> 
   Set_P (\<lambda> ((x0_3::'a), (x1_3::'b)). P__a x0_3 \<and> P__b x1_3)
      (FMap__fromFMap m2)"
  by auto
      ...
      x = FMap__fromFMap m1 
        \<longrightarrow> finite x 
              \<and> (Relation__functional_p__stp(P__a, P__b)
               ...
               \<and> Set_P
                    (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1) x); 
    x_2 = FMap__fromFMap m1\<rbrakk> \<Longrightarrow> 
   Relation__functional_p__stp(P__a, P__b)
      (RFun (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1) x_2) 
     \<and> Set_P (\<lambda> ((x0_1::'a), (x1_1::'b)). P__a x0_1 \<and> P__b x1_1) x_2"
  by auto
theorem FMap__e_lt_lt_lt__stp_Obligation_subtype0: 
  "\<lbrakk>FMap__FMap_P(P__a, P__b) m2; 
    \<forall>(x_3::('a \<times> 'b) set). 
      x_3 = FMap__fromFMap m2 
        \<longrightarrow> finite x_3 
              \<and> (Relation__functional_p__stp(P__a, P__b)
                    (RFun
                        (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1) x_3) 
               \<and> Set_P
                    (\<lambda> ((x0_2::'a), (x1_2::'b)). 
                       P__a x0_2 \<and> P__b x1_2) x_3); 
    x_5 = FMap__fromFMap m2\<rbrakk> \<Longrightarrow> 
   Relation__functional_p__stp(P__a, P__b)
      (RFun (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1) x_5) 
     \<and> Set_P (\<lambda> ((x0_3::'a), (x1_3::'b)). P__a x0_3 \<and> P__b x1_3) x_5"
  by auto
theorem FMap__e_lt_lt_lt__stp_Obligation_subtype1: 
  "\<lbrakk>FMap__FMap_P(P__a, P__b) m2; 
    FMap__FMap_P(P__a, P__b) m1; 
    \<forall>(x_6::('a \<times> 'b) set). 
      x_6 
        = MapAC__e_lt_lt_lt__stp(P__a, P__b)
            (RFun (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1)
             ...
             RFun (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1)
                (FMap__fromFMap m2)) 
        \<longrightarrow> Relation__functional_p__stp(P__a, P__b)
               (RFun (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1) x_6) 
              \<and> Set_P
                   (\<lambda> ((x0_4::'a), (x1_4::'b)). 
                      P__a x0_4 \<and> P__b x1_4) x_6; 
    x_7 
      = MapAC__e_lt_lt_lt__stp(P__a, P__b)
          (RFun (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1)
              (FMap__fromFMap m1), 
           RFun (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1)
              (FMap__fromFMap m2))\<rbrakk> \<Longrightarrow> 
   finite x_7 
     \<and> (Relation__functional_p__stp(P__a, P__b)
           (RFun (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1) x_7) 
      \<and> Set_P
           (\<lambda> ((x0_5::'a), (x1_5::'b)). P__a x0_5 \<and> P__b x1_5) x_7)"
   sorry
...
theorem FMap__e_lt_lt_lt_Obligation_subtype0: 
  "\<lbrakk>\<forall>(x_1:: ('a, 'b)Relation__Relation). 
      x_1 = FMap__fromFMap m2 
        \<longrightarrow> finite x_1 \<and> Relation__functional_p x_1\<rbrakk> \<Longrightarrow> 
   Relation__functional_p (FMap__fromFMap m2)"
  by auto
theorem FMap__e_lt_lt_lt_Obligation_subtype1: 
  "\<lbrakk>Relation__functional_p (FMap__fromFMap m1 <<< FMap__fromFMap m2); 
    x_2 = FMap__fromFMap m1 <<< FMap__fromFMap m2\<rbrakk> \<Longrightarrow> 
   finite x_2 \<and> Relation__functional_p x_2"
   sorry
consts FMap__e_lt_lt_lt :: " ('a, 'b)FMap__FMap \<Rightarrow> 
                             ('a, 'b)FMap__FMap \<Rightarrow>  ('a, 'b)FMap__FMap"	(infixl "<<<" 65)
defs FMap__e_lt_lt_lt_def: 
  "(m1 <<< m2)
     \<equiv> FMap__toFMap (FMap__fromFMap m1 <<< FMap__fromFMap m2)"
    ...
    \<forall>(x_3::('a \<times> 'b) set). 
      x_3 
        = MapAC__update__stp(P__a, P__b)
             (RFun (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1)
                 (FMap__fromFMap m)) x y 
        \<longrightarrow> Relation__functional_p__stp(P__a, P__b)
               (RFun (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1) x_3) 
              \<and> Set_P
                   (\<lambda> ((x0_2::'a), (x1_2::'b)). 
                      P__a x0_2 \<and> P__b x1_2) x_3; 
    x_4 
      = MapAC__update__stp(P__a, P__b)
           (RFun (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1)
               (FMap__fromFMap m)) x y\<rbrakk> \<Longrightarrow> 
   finite x_4 
     \<and> (Relation__functional_p__stp(P__a, P__b)
           (RFun (\<lambda> ((x0::'a), (x1::'b)). P__a x0 \<and> P__b x1) x_4) 
      \<and> Set_P
           (\<lambda> ((x0_3::'a), (x1_3::'b)). P__a x0_3 \<and> P__b x1_3) x_4)"
   sorry
...
theorem FMap__update_Obligation_subtype0: 
  "\<lbrakk>Relation__functional_p
       (MapAC__update (FMap__fromFMap m) x y); 
    x_1 = MapAC__update (FMap__fromFMap m) x y\<rbrakk> \<Longrightarrow> 
   finite x_1 \<and> Relation__functional_p x_1"
   sorry
...
theorem FMap__e_dsh_dsh_Obligation_subtype0: 
  "\<lbrakk>Relation__functional_p (FMap__fromFMap m -- FSet__fromFSet xS); 
    x_1 = FMap__fromFMap m -- FSet__fromFSet xS\<rbrakk> \<Longrightarrow> 
   finite x_1 \<and> Relation__functional_p x_1"
   sorry
...
defs e_dsh_dsh_fm_def: 
  "(m --_fm xS)
     \<equiv> FMap__toFMap (FMap__fromFMap m -- FSet__fromFSet xS)"
...
theorem FMap__e_dsh_Obligation_subtype0: 
  "\<lbrakk>Relation__functional_p (FMap__fromFMap m mless (x::'a)); 
    x_1 = FMap__fromFMap m mless x\<rbrakk> \<Longrightarrow> 
   finite x_1 \<and> Relation__functional_p x_1"
   sorry
...
theorem FMap__e_fsl_bsl_Obligation_subtype: 
  "\<lbrakk>FMap__agree_p(m1, m2); 
    x_2 = FMap__fromFMap m1 \<inter> FMap__fromFMap m2\<rbrakk> \<Longrightarrow> 
   finite x_2 \<and> Relation__functional_p x_2"
   sorry
consts FMap__e_fsl_bsl :: " ('a, 'b)FMap__FMap \<Rightarrow> 
                            ('a, 'b)FMap__FMap \<Rightarrow>  ('a, 'b)FMap__FMap"	(infixr "'/\\" 65)
defs FMap__e_fsl_bsl_def: 
  "(m1 /\\ m2)
     \<equiv> FMap__toFMap (FMap__fromFMap m1 \<inter> FMap__fromFMap m2)"
theorem FMap__e_bsl_fsl_Obligation_subtype: 
  "\<lbrakk>FMap__agree_p(m1, m2); 
    x_2 = FMap__fromFMap m1 \<union> FMap__fromFMap m2\<rbrakk> \<Longrightarrow> 
   finite x_2 \<and> Relation__functional_p x_2"
   sorry
consts FMap__e_bsl_fsl :: " ('a, 'b)FMap__FMap \<Rightarrow> 
                            ('a, 'b)FMap__FMap \<Rightarrow>  ('a, 'b)FMap__FMap"	(infixr "\\'/" 64)
defs FMap__e_bsl_fsl_def: 
  "(m1 \\/ m2)
...
theorem FMap__filter_Obligation_subtype: 
  "\<lbrakk>x_1 = FMap__fromFMap m \<inter> (p::'a \<times> 'b \<Rightarrow> bool)\<rbrakk> \<Longrightarrow> 
   finite x_1 \<and> Relation__functional_p x_1"
   sorry
...
theorem FMap__restrictDomain_Obligation_subtype: 
  "\<lbrakk>x_1 = FMap__fromFMap m restrictDomain (p::'a \<Rightarrow> bool)\<rbrakk> \<Longrightarrow> 
   finite x_1 \<and> Relation__functional_p x_1"
   sorry
consts FMap__restrictDomain :: " ('a, 'b)FMap__FMap \<Rightarrow> 
                                ('a \<Rightarrow> bool) \<Rightarrow>  ('a, 'b)FMap__FMap"	(infixl "restrictDomain" 65)
defs FMap__restrictDomain_def: 
  "(m restrictDomain (p::'a \<Rightarrow> bool))
     \<equiv> FMap__toFMap (FMap__fromFMap m restrictDomain p)"
theorem FMap__restrictRange_Obligation_subtype: 
  "\<lbrakk>x_1 = FMap__fromFMap m restrictRange (p::'b \<Rightarrow> bool)\<rbrakk> \<Longrightarrow> 
   finite x_1 \<and> Relation__functional_p x_1"
   sorry
consts FMap__restrictRange :: " ('a, 'b)FMap__FMap \<Rightarrow> 
                               ('b \<Rightarrow> bool) \<Rightarrow>  ('a, 'b)FMap__FMap"	(infixl "restrictRange" 65)
defs FMap__restrictRange_def: 
  "(m restrictRange (p::'b \<Rightarrow> bool))
     \<equiv> FMap__toFMap (FMap__fromFMap m restrictRange p)"
(* theorem FMap__single_Obligation_subtype:  *)
(*   "\<lbrakk>x0 = Set__single(x0, y)\<rbrakk> \<Longrightarrow>  *)
(*    finite x0 \<and> Relation__functional_p x0" *)
(*    sorry *)
...
theorem FMap__thePair_Obligation_subtype: 
  "\<lbrakk>Set__single_p (FMap__fromFMap (m:: ('a, 'b)FMap__FMap)); 
    \<forall>(x:: ('a, 'b)Relation__Relation). 
      x = FMap__fromFMap m 
        \<longrightarrow> finite x \<and> Relation__functional_p x\<rbrakk> \<Longrightarrow> 
...
theorem FMap__fold_Obligation_subtype0: 
  "\<lbrakk>FMap__foldable_p((c::'c), (f::'c \<times> ('a \<times> 'b) \<Rightarrow> 'c), m); 
    finite (FMap__fromFMap m); 
    x_1 = (c, f, FMap__fromFMap m)\<rbrakk> \<Longrightarrow> 
...
theorem FMap__inverse_Obligation_subtype: 
  "\<lbrakk>Relation__injective_p (FMap__fromFMap (m:: ('a, 'b)FMap__FMap)); 
    x_1 = Relation__inverse (FMap__fromFMap m)\<rbrakk> \<Longrightarrow> 
   finite x_1 \<and> Relation__functional_p x_1"
   sorry
...
theorem FMap__fromFSet_Obligation_subtype: 
  "\<lbrakk>Relation__functional_p (FSet__fromFSet s); 
    ...
    x = FSet__fromFSet s\<rbrakk> \<Longrightarrow> finite x \<and> Relation__functional_p x"
  by auto
