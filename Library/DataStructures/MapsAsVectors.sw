% Is the code for the MapVec functions supposed to come from Specware/Library/Structures/Data/Maps/Handwritten/Lisp/MapAsVector.lisp?
...
% how to handle apply outside the domain in MapVec?
