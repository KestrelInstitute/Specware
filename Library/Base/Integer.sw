Integer qualifying spec
  ...
  % refinement of base spec Integer
 ...
 %op +   infixl 25 : Integer * Integer -> Integer
  ...
  op div infixl 26 : Integer * NZInteger -> Integer
  op rem infixl 26 : Integer * NZInteger -> Integer
 %op <   infixl 20 : Integer * Integer -> Boolean
  op <=  infixl 20 : Integer * Integer -> Boolean

  % axioms copied from base spec Integer:
  ...
  axiom division_def is
    fa (x : Integer, y : NZInteger, z : Integer)
