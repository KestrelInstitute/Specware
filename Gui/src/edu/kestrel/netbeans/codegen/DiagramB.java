...
/**
 * Specialized document binding for a DiagramElement.
 *
 */
class DiagramB extends Member implements Binding.Diagram, TextBinding.Container {
    /**
     * Support for the containment of member elements.
     */
    ContainerSupport    container;
    
    public DiagramB(DiagramElement el, SourceText s) {
        super(el, s);
    }
     ...
     * not its children, as DiagramElement.clone() normally does.
     */
    protected Element cloneElement() {
        DiagramElement x = new DiagramElement();
        DiagramElement my = (DiagramElement)getElement();
        try {
    ...
    private DiagramElement cloneDiagram() {
        return (DiagramElement)cloneElement();
    }
    ...
    public void create(PositionBounds bounds) throws SourceException {
        DiagramElement c = cloneDiagram();
        DiagramElement orig = (DiagramElement)getElement();
