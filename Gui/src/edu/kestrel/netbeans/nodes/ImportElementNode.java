/*
 * ImportElementNode.java
 *
 * Created on February 17, 2003, 6:23 PM
 */
 ...
 * @author  weilyn
 */
public class ImportElementNode extends MemberElementNode {
    /** Create a new import node.
    * @param element import element to represent
    * @param writeable <code>true</code> to be writable
    */
    public ImportElementNode(ImportElement element, boolean writeable) {
        super(element, Children.LEAF, writeable);
        setElementFormat0(sourceOptions.getImportElementFormat());
    }

    public org.openide.util.HelpCtx getHelpCtx () {
        return new org.openide.util.HelpCtx ("org.openide.src.nodes.ImportNode"); // NOI18N
    }
    ...
    */
    protected ElementFormat getHintElementFormat() {
        return sourceOptions.getImportElementLongFormat();
    }
    ...
    */
    public void destroy() throws IOException {
        SourceEditSupport.invokeAtomicAsUser(element, new SourceEditSupport.ExceptionalRunnable() {
                                                 public void run() throws SourceException {
                                                     ImportElement el = (ImportElement) element;
                                                     ((SpecElement) el.getParent()).removeImport(el);
                                                 }
                                             });
        super.destroy();
    }
    ...
    public Component getCustomizer() {
        return null;   // new ImportCustomizer((ImportElement)element);
    }
