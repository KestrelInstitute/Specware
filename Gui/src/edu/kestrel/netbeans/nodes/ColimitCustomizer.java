 ...
 * @author  weilyn
 */
public class ColimitCustomizer extends javax.swing.JPanel {
    ...
    public ColimitCustomizer(SpecElement newProveElem, SpecElement parentSpecElem, ClaimElement claimElement) {
        initComponents();
