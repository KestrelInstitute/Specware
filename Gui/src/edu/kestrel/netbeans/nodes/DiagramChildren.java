...
/** Normal implementation of children list for a diagram element node.
* Semantics are similar to those of {@link SourceChildren}.
*/
public class DiagramChildren extends Children.Keys implements FilterCookie {
...
/*        propToFilter.put (ElementProperties.PROP_IMPORTS, new Integer (SpecElementFilter.IMPORT));        
    ...
    /** The diagram element whose subelements are represented. */
    protected DiagramElement              element;
    /** Filter for elements, or <code>null</code> to disable. */
    protected DiagramElementFilter        filter;
    ...
    * be kept to prevent the listener from finalizing when we are alive */
    ...
    /** Create diagram children with the default factory.
    * The children are initially unfiltered.
    * @param element attached class element (non-<code>null</code>)
    */
    public DiagramChildren(final DiagramElement element) {
    ...
    * @param element attached class element (non-<code>null</code>)
    */
    public DiagramChildren(final ElementNodeFactory factory, final DiagramElement element) {
        super();
    ...
    */
    public Class getFilterClass () {
        return DiagramElementFilter.class;
    }
    ...
    */
    public void setFilter (final Object filter) {
        if (!(filter instanceof DiagramElementFilter)) throw new IllegalArgumentException();
        this.filter = (DiagramElementFilter)filter;
...
/*        if (key instanceof ImportElement) {
    ...
    */
    protected void refreshAllKeys () {
        ...
        refreshKeys (DiagramElementFilter.ALL);
    }
    ...
    */
    protected int[] getOrder () {
        return (filter == null || (filter.getOrder() == null))
               ? DiagramElementFilter.DEFAULT_ORDER : filter.getOrder();
    }
