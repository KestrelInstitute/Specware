...
/** Normal implementation of children list for a spec element node.
* Semantics are similar to those of {@link SourceChildren}.
*/
public class SpecChildren extends Children.Keys implements FilterCookie {
    ...
    protected SpecElement              element;
    /** Filter for elements, or <code>null</code> to disable. */
    protected SpecElementFilter        filter;
    ...
    * @param element attached class element (non-<code>null</code>)
    */
    public SpecChildren (final ElementNodeFactory factory,
				final SpecElement element) {
        super();
    ...
    */
    public Class getFilterClass () {
        return SpecElementFilter.class;
    }
    ...
    */
    public void setFilter (final Object filter) {
        if (!(filter instanceof SpecElementFilter)) throw new IllegalArgumentException();
        this.filter = (SpecElementFilter)filter;
    ...
    */
    protected void refreshAllKeys () {
        ...
        refreshKeys (SpecElementFilter.ALL);
    }
    ...
    */
    protected int[] getOrder () {
        return (filter == null || (filter.getOrder() == null))
               ? SpecElementFilter.DEFAULT_ORDER : filter.getOrder();
    }
