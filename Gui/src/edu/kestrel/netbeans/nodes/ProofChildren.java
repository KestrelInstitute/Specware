...
/** Normal implementation of children list for a proof element node.
* Semantics are similar to those of {@link SourceChildren}.
*/
public class ProofChildren extends Children.Keys implements FilterCookie {
...
/*        propToFilter.put (ElementProperties.PROP_IMPORTS, new Integer (SpecElementFilter.IMPORT));        
    ...
    /** The proof element whose subelements are represented. */
    protected ProofElement              element;
    /** Filter for elements, or <code>null</code> to disable. */
    protected ProofElementFilter        filter;
    ...
    * be kept to prevent the listener from finalizing when we are alive */
    ...
    /** Create proof children with the default factory.
    * The children are initially unfiltered.
    * @param element attached class element (non-<code>null</code>)
    */
    public ProofChildren(final ProofElement element) {
    ...
    * @param element attached class element (non-<code>null</code>)
    */
    public ProofChildren(final ElementNodeFactory factory, final ProofElement element) {
        super();
    ...
    */
    public Class getFilterClass () {
        return ProofElementFilter.class;
    }
    ...
    */
    public void setFilter (final Object filter) {
        if (!(filter instanceof ProofElementFilter)) throw new IllegalArgumentException();
        this.filter = (ProofElementFilter)filter;
...
/*        if (key instanceof ImportElement) {
    ...
    */
    protected void refreshAllKeys () {
        ...
        refreshKeys (ProofElementFilter.ALL);
    }
    ...
    */
    protected int[] getOrder () {
        return (filter == null || (filter.getOrder() == null))
               ? ProofElementFilter.DEFAULT_ORDER : filter.getOrder();
    }
