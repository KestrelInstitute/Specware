 ...
 * @author  weilyn
 */
public class DiagramCustomizer extends javax.swing.JPanel {
    ...
    public DiagramCustomizer(SpecElement newProveElem, SpecElement parentSpecElem, ClaimElement claimElement) {
        initComponents();
