...
/**
 * Holds parsed out information about a proof.
 *
 */
public class ProofInfo extends BaseElementInfo {
...
/*	SortElement.class,
    ...
    public void updateElement(LangModel.Updater model, Element target) throws SourceException {
        Util.log("ProofInfo.updateElement this = "+this+" target "+target);
...
*/        model.updateMemberOrder(proof, ElementProperties.PROP_MEMBERS, whole);
    ...
    public Element createModelImpl(LangModel.Updater model, Element parent) {
        ...
        //Util.log("*** ProofInfo.createModelImpl: Creating a proof " + name); // NOI18N
	impl = model.createProof(parent);
        return impl.getElement();
    }
    
    public void addMember(int kind, BaseElementInfo member) {
        //Util.log("*** ProofInfo.addMember: " + member.name); // NOI18N
        member.parent = this;
