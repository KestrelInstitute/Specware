...
if [ $# -ne 2 ]
then
    echo "test.sh: Error: Argument must be the Specware installation to test and ISABELLE_2014_ROOT."
    exit 1
fi
...
run-isabelle2014-build.sh ${SPECWARE4}/Examples/Misc/Isa ${ISABELLE_2014_ROOT}
