...
* ctext <path>/Msort.sw         %% evaluate this metaprogram (where <path> 
                                %% is the path to this file)
* ld msort.lisp                 %% load the lisp code (or use cl to compile-and-load)
* el Msort [10, 4, 7, 3, 12, 1] %% execute the code
...
asMergeSort = morphism ../../Library/AlgorithmTheories/DivideAndConquer#DC_012 -> Sorting_as_DC
            { D +-> coBagNat
            , R +-> ListNat
            , O +-> sorted2?
            , E    +-> Nat
...
MergeSort = ../../Library/AlgorithmTheories/DivideAndConquer#DC_012_scheme[asMergeSort]
