...
(new-function-name declare-variable declare-variable-symbol)
(new-function-name declare-free-variable declare-variable-symbol)
...
(defun initialize-backward-compatibility ()
  ...
  (let-options ((allow-keyword-constant-symbols t)
    ...
    (declare-proposition-symbol false                    :alias :false)
    (declare-proposition-symbol true                     :alias :true)
    (declare-predicate-symbol (function-name *=*) :any   :alias '(:= equal))
    (declare-predicate-symbol '/= :any                   :alias :/=)
    (declare-function-symbol 'list :any                  :alias 'listof)
...
;;; specification in declare-constant-symbol, declare-function-symbol, declare-predicate-symbol
