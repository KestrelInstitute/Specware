...
properties of the proof theory (see \secref{props}).
\item
...
$\bool$.
%Note that the variable $\var$ used in the universal quantification
%must not occur free in $\expr$, otherwise it would be captured.
%\item
