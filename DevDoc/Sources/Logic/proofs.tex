...
\begin{bycase}
\Case{$\opO$, $\descopO$, $\pjop{\fnam}$, $\quo$}
\begin{derivation}
...
\begin{bycase}
\Case{$\var$, $\opO$, $\descopO$, $\pjop{\fnam}$, $\quo$}
\begin{derivation}
...
\Case{\Reop, \Redesc, \Reproj, \Requot}\\
$\efvar{\expr}=\emptyset$
...
\Rthquotsurj, \Rthquoteclass, and \Rthprojsub.
%\Rthembsub.
...
has no free variables (by \thmref{thm-efvar-abbrev} and, for \Rthquoteclass,
also by \thmref{thm-no-free-vars-in-types}) and so $\esbsren{\expr}=\expr$ by
\thmref{thm-esbs-not-free}.
