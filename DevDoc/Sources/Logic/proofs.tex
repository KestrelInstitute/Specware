...
%\[
%\rruleII
% {\cxwf{\snoc{\cx}{\vdec{\var}{\tarr{\typ}{\bool}}}}}
% {\var'\neq\var}
% {\hasty{\snoc{\cx}{\vdec{\var}{\tarr{\typ}{\bool}}}}
%        {\fa{\var'}{\typ}{\nega{(\app{\var}{\var'})}}}{\bool}}
% {\RtmpI}
%\]
%If $\var'\not\in\cxvarO$, the rule is derived as follows:
%\begin{derivation}
%\step{\cxwf{\snoc{\cx}{\vdec{\var}{\tarr{\typ}{\bool}}}}}
%     {\hyp}
%\step{\istyO{\tarr{\typ}{\bool}}}{\thmref{thm-var-type-wf}, 1}
%\step{\istyO{\typ}}{\thmref{thm-tarr-inv}, 2}
%\step{\isty{\snoc{\cx}{\vdec{\var}{\tarr{\typ}{\bool}}}}{\typ}}
%     {\thmref{thm-mono}, 3, 1}
%\step{\cxwf{\snoc{\snoc{\cx}{\vdec{\var}{\tarr{\typ}{\bool}}}}
%                            {\vdec{\var'}{\typ}}}}
%     {\Rcxvdec, 1, 4, \hyp\ $\var'\neq\var\AND\var'\not\in\cxvarO$}
%\step{\hasty{\snoc{\snoc{\cx}{\vdec{\var}{\tarr{\typ}{\bool}}}}
%                             {\vdec{\var'}{\typ}}}
%            {\var}{\tarr{\typ}{\bool}}}
%     {\Revar, 5}
%\step{\hasty{\snoc{\snoc{\cx}{\vdec{\var}{\tarr{\typ}{\bool}}}}
...
%            {\nega{(\app{\var}{\var'})}}{\bool}}
%     {\Renega, 8}
%\step{\hasty{\snoc{\cx}{\vdec{\var}{\tarr{\typ}{\bool}}}}
%            {\fa{\var'}{\typ}{\nega{(\app{\var}{\var'})}}}{\bool}}
%     {\Refa, 9}
%\end{derivation}
%If instead $\var'\in\cxvar{\cx}$, we can use a very analogous derivation to
...
%       {\bool}$,
%where $\var''\neq\var'$ is a fresh variable not declared in $\cx$, i.e.\
%$\var''\not\in\cxvar{\cx}$; then we use rule......

%TO DO: need exForAllAlpha

%$\Reabsalpha$ to rename $\var''$ to $\var'$. This concludes the proof of rule
%\RtmpI.
