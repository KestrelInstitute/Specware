...
\begin{derivation}
\step{\cxwf{\cx_1,\lemO,\cx_2}}{\hyp}
\step{\cxwf{\cx_1,\lemO}}{\thmref{thm-cxprefix}, 1}
\step{\theo{\snoc{\cx_1}{\tvdec{\tvarS}}}{\expr}}{\thmref{thm-lem-theo}, 2}
...
Before proving the above implications, note that from the last one we can
prove
\[
...
If $\cx\neq\mtcx$:
\begin{derivation}
\steP{\EXISTS{\cx_0,\cxel}{\cx=\cx_0,\cxel}}
\steP
{\cxtvarO
 \link{\supseteq}{1}
 \cxtvar{\cx_0}
...
\step{\cxtvar{\cx_1}\supseteq\ftvar{\cx_1,\cxel}}{\indhyp, 2}
\end{derivation}
...
\step{\cxwf{\cx_1}}{\premof{\Rcxtdec}}
\step{\cxtvar{\cx_1}\supseteq\ftvar{\cx_1}}{\indhyp, 3, $(*)$}
\step{\cxtvar{\cx_1}\supseteq\ftvar{\cx_1,\cxel}}{4, 2}
\end{derivation}
...
\step{\cxtvar{\cx_1}\cup\tvarS\supseteq\ftvar{\cx_1}\cup\ftvar{\typ}}
     {\indhyp, 3}
\step{(\cxtvar{\cx_1}\cup\tvarS)-\tvarS\supseteq
      (\ftvar{\cx_1}\cup\ftvar{\typ})-\tvarS}
     {4}
...
\step{\cxwf{\cx_1}}{\premof{\Rcxodec}}
\step{\cxtvar{\cx_1}\supseteq\ftvar{\cx_1}}{\indhyp, 9, $(*)$}
\step{\tvarS\cap\ftvar{\cx_1}=\emptyset}{7, 10}
\step{\ftvar{\cx_1}-\tvarS=\ftvar{\cx_1}}{11}
\step{\cxtvar{\cx_1}\supseteq\ftvar{\cx_1,\cxel}}{5, 8, 12, 2}
\end{derivation}
...
\step{\cxtvar{\cx_1}\supseteq\ftvar{\cx_1}\cup\ftvar{\typ}}{\indhyp, 2}
\step{\cxtvar{\cx_1}\supseteq\ftvar{\cx_1,\cxel}}{3, 1}
\end{derivation}

\Case{\Rtbool}
\begin{derivation}
\step{\cxwfO}{\premof{\Rtbool}}
\steP
{\cxtvarO
 \link{\supseteq}{\indhyp, 1, $(*)$}
 \ftvar{\cx}
 \link{=}{$\ftvar{\bool}=\emptyset$}
 \ftvar{\cx}\cup\ftvar{\bool}}
\end{derivation}

\Case{\Rtvar}
\begin{derivation}
\step{\cxwfO}{\premof{\Rtvar}}
\step{\cxtvarO\supseteq\ftvar{\cx}}{\indhyp, 1, $(*)$}
\step{\tvar\in\cxtvarO}{\premof{\Rtvar}}
\step{\cxtvarO\supseteq\ftvar{\cx}\cup\ftvar{\tvar}}{2, 3}
\end{derivation}
...
\step{\FORALL{i}{\cxtvarO\supseteq\ftvar{\cx}\cup\ftvar{\typ_i}}}{\indhyp, 2}
\step{\FORALL{i}{\cxtvarO\supseteq\ftvar{\typ_i}}}{3}
\step{\cxtvarO\supseteq\ftvar{\tinstO}}{1, 4}
\step{\cxwfO}{\premof{\Rtinst}}
\step{\cxtvarO\supseteq\ftvar{\cx}}{\indhyp, 6, $(*)$}
\step{\cxtvarO\supseteq\ftvar{\cx}\cup\ftvar{\tinstO}}{5, 7}
\end{derivation}
...
%\step{\FORALL{i}{\cxtvarO\supseteq\ftvar{\cx}\cup\ftvar{\typ_i}}}{\indhyp, 3}
%\step{\FORALL{i}{\cxtvarO\supseteq\ftvar{\typ_i}}}{4}
%\step{\cxtvarO\supseteq\ftvar{\tinstO}}{5, 1}
%\step{\tdefO\in\cx}{\premof{\Rtedef}}
%\step{\EXISTS{\cx_1,\cx_2}{\cx=\cx_1,\tdefO, \cx_2}}{7}
%\step{\cxwf{\cx}}{\premof{\Rtedef}}
%\steP
%{\cxtvarO
% \link{\supseteq}{8}
% \cxtvar{\cx_1}
% \link{\supseteq}{\indhyp, 9, 8}
% \ftvar{\cx_1,\tdefO}
% \linK{\supseteq}
% \ftvar{\typ}-\tvarS}
%\steP{\bigcup_{\tvar_i\in\ftvar{\typ}}\ftvar{\typ_i}\subseteq
%      \bigcup_i\ftvar{\typ_i}}
%\step{\cxtvarO\supseteq\bigcup_{\tvar_i\in\ftvar{\typ}}\ftvar{\typ_i}}{5, 11}
%\step{\cxtvarO\supseteq\ftvar{\cx}}{\indhyp, 9, $(*)$}
%\step{\cxtvarO\supseteq
%      \ftvar{\cx}\cup\ftvar{\tinstO}\cup\ftvar{\tsbslash{\typ}{\tvarS}{\typS}}}
%     {13, 6, 2, 10, 12}
%\end{derivation}
...
{\cxtvarO
 ...
 \ftvar{\cx_1}\cup\ftvar{\typ}
 \linK{\supseteq}
 \ftvar{\typ}}
\step{\cxwfO}{\premof{\Revar}}
\step{\cxtvarO\supseteq\ftvar{\cx}}{\indhyp, 5, $(*)$}
\step{\cxtvarO\supseteq\ftvar{\cx}\cup\ftvar{\typ}}{6, 4}
\end{derivation}
...
\step{\FORALL{i}{\cxtvarO\supseteq\ftvar{\cx}\cup\ftvar{\typ_i}}}{\indhyp, 3}
\step{\FORALL{i}{\cxtvarO\supseteq\ftvar{\typ_i}}}{4}
\step{\cxtvarO\supseteq\ftvar{\opO}}{5, 1}
\step{\odecO\in\cx}{\premof{\Reop}}
\step{\EXISTS{\cx_1,\cx_2}{\cx=\cx_1,\odecO, \cx_2}}{7}
...
\step{\cxtvarO\supseteq\ftvar{\cx}}{\indhyp, 9, $(*)$}
\step{\cxtvarO\supseteq
      \ftvar{\cx}\cup\ftvar{\opO}\cup\ftvar{\tsbslash{\typ}{\tvarS}{\typS}}}
     {13, 6, 2, 10, 12}
\end{derivation}
...
\step{\cxtvar{\cx,\vdecO}\supseteq
      \ftvar{\cx,\vdecO}\cup\ftvar{\expr}\cup\ftvar{\typ'}}
     {\indhyp, 1}
\step{\cxtvarO\supseteq
      \ftvar{\cx}\cup\ftvar{\typ}\cup\ftvar{\expr}\cup\ftvar{\typ'}}
     {2}
\steP{\ftvar{\absO}=\ftvar{\typ}\cup\ftvar{\expr}}
\steP{\ftvar{\tarr{\typ}{\typ'}}=\ftvar{\typ}\cup\ftvar{\typ'}}
\step{\cxtvarO\supseteq
      \ftvar{\cx}\cup\ftvar{\absO}\cup\ftvar{\tarr{\typ}{\typ'}}}
     {3, 4, 5}
\end{derivation}
...
\Reif, \Rthifsbs, \Rthif). We use \thmref{thm-ftvar-abbrev} for
% \Rtquot,
\Rstrefl, \Rstarr, \Rstrec,
% \Rstsum,
\Redesc, \Rthbool, \Rthext, \Rthrec,
%\Rthembsurj, \Rthembdist, \Rthembinj,
%\Rthquotsurj, \Rthquoteclass,
and \Rthprojsub.
%\Rthembsub.
We use \thmref{thm-rename-same-free-tvars} for \Reabsalpha. We use
\thmref{thm-ftvar-of-esbs} for \Rthabs.

\end{bycase}

% THIS IS THE PROOF BY INDUCTION ON THE SIZE (VS. SIMPLE RULE INDUCTION):
...
%\]
%by \thmref{thm-cxprefix}. We prove the first five implications of the original
...
$\varI'$ in the premises of the rule instance and then we apply the rule to
the transformed premises to obtain the conclusion with $\varI$ replaced with
$\varI'$. We use \thmref{thm-esbs-cx-decl} for \Rtvar, \Rtinst, and \Reop\ and
we use \thmref{thm-esbs-abbrev} for \Reif, \Rthifsbs, and \Rthif.
...
%\thmref{thm-no-free-vars-in-types}) and therefore
%$\esbsren{(\eq{\tspred}{\tspred'})}=(\eq{\tspred}{\tspred'})$ by
%\thmref{thm-esbs-not-free}.
%% We use analogous reasoning for \Rtequot.
...
has no free variables (by \thmref{thm-efvar-abbrev}) and so
$\esbsren{\expr}=\expr$ by \thmref{thm-esbs-not-free}.
...
\step{\cxwf{\cx'}}{\hyp}
\step{\cx\subseteq\cx'}{\hyp}
\step{\istyO{\typ'}}{\premof{\Reabs}}
\step{\isty{\cx'}{\typ'}}{\indhyp, 7}
\end{derivation}
If $\var\not\in\cxvar{\cx'}$:
\begin{derivatioN}{8}
\step{\cxwf{\snoc{\cx'}{\vdecO}}}{\Rcxvdec, 5, 4}
\step{\snoc{\cx}{\vdecO}\subseteq\snoc{\cx'}{\vdecO}}{6}
\step{\hasty{\cx',\vdecO}{\expr}{\typ'}}{\indhyp, 1, 9, 10}
\step{\hasty{\cx'}{\abs{\var}{\typ}{\expr}}{\tarr{\typ}{\typ'}}}{\Reabs, 11, 8}
\end{derivatioN}
...
\step{\var\not\in\efvar{\esbs{\expr}{\var}{\var'}}}
     {\thmref{thm-var-not-in-esbs-of-var}, 14, 15}
...
\step{\var\not\in\cvarv{\esbs{\expr}{\var}{\var'}}{\var'}}{18, 19}
\step{\hasty{\cx'}
            {\abs{\var}{\typ}{\esbs{\esbs{\expr}{\var}{\var'}}{\var'}{\var}}}
            {\tarr{\typ}{\typ'}}}
     {\Reabsalpha, 13, 16, 20}
\step{\esbs{\esbs{\expr}{\var}{\var'}}{\var}{\var'}=\expr}
     {\thmref{thm-esbs-inverse}, 14, 17}
\step{\hasty{\cx'}{\absO}{\tarr{\typ}{\typ'}}}{21, 22}
\end{derivatioN}
...
\step{\isty{\cx_1,\cx_2,\tsbslash{\cx_2}{\tvarIS}{\typIS}}{\typ'}}
     {\indhyp, 6}
\end{derivation}
If $\var\not\in\cx_2$:
\begin{derivatioN}{7}
...
\step{\cxwf{\snoc{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS}}
     ...
     {\Rcxvdec, 9, 8, 4}
\step{\tsbslashok{\cx_3}{\tvarIS}{\typIS}}{\hyp}
\step{\tvarIS\cap\cxtvar{\cx_3}=\emptyset}{11}
\step{\tvarIS\cap
      \cxtvar{\snoc{\cx_3}{\vdec{\var}{\tsbslash{\typ}{\tvarIS}{\typIS}}}}
      =\emptyset}
     {12}
\step{\FORALL{i}{\ftvar{\typI_i}\cap\ctvar{\cx_3}{\tvarI_i}=\emptyset}}{11}
...
\stepL{\hasty{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS}}
             ...
             {\tarr{\tsbslash{\typ}{\tvarIS}{\typIS}}
                   {\tsbslash{\typ'}{\tvarIS}{\typIS}}}}
      {analogous derivation as 8--19 above for case $\var\not\in\cx_2$}
\step{\fresh{\var'}}{\hyp}
\step{\esbsok{\expr}{\var}{\var'}}{10}
\step{\var\not\in\efvar{\esbs{\expr}{\var}{\var'}}}
     {\thmref{thm-var-not-in-esbs-of-var}, 11, 10}
\step{\var\not\in\efvar{\tsbslash{\esbs{\expr}{\var}{\var'}}{\tvarIS}{\typIS}}}
     {\thmref{thm-tsbs-same-free-vars}, 12}
\step{\var\not\in\cvarv{\expr}{\var}}{\thmref{thm-var-not-capt}}
\step{\var\not\in\cvarv{\esbs{\expr}{\var}{\var'}}{\var'}}
     {\thmref{thm-capt-rename1}, 11, 10, 14}
\step{\var\not\in
      \cvarv{\tsbslash{\esbs{\expr}{\var}{\var'}}{\tvarIS}{\typIS}}{\var'}}
     {\thmref{thm-tsbs-same-capt-vars}, 15}
\stepL{\hasty{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS}}
             {\abs{\var}{\tsbslash{\typ}{\tvarIS}{\typIS}}
...
\step{\hasty{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS}}
            {\abs{\var}{\tsbslash{\typ}{\tvarIS}{\typIS}}
                 {\tsbslash{\esbs{\esbs{\expr}{\var}{\var'}}{\var'}{\var}}
                           {\tvarIS}{\typIS}}}
            {\tsbslash{(\tarr{\typ}{\typ'})}{\tvarIS}{\typIS}}}
     {\thmref{thm-esbs-tsbs-comm}, 17}
\step{\hasty{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS}}
            {\abs{\var}{\tsbslash{\typ}{\tvarIS}{\typIS}}
                 {\tsbslash{\expr}{\tvarIS}{\typIS}}}
            {\tsbslash{(\tarr{\typ}{\typ'})}{\tvarIS}{\typIS}}}
     {\thmref{thm-esbs-inverse}, 18, 11, 10}
\step{\hasty{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS}}
            {\tsbslash{(\absO)}{\tvarIS}{\typIS}}
            {\tsbslash{(\tarr{\typ}{\typ'})}{\tvarIS}{\typIS}}}
     {19}
...
\thmref{thm-tsbs-same-free-vars} for \Rtsub.
% \Rtquot,
%and \Rterestr.
%, and \Rtequot.
We use \thmref{thm-tsbs-abbrev} for
% \Rtquot,
\Rstrefl, \Rstarr, \Rstrec,
%\Rstsum,
...
and \Rthprojsub.
%and \Rthembsub.
We use \thmref{thm-tsbs-same-free-vars},
...
\subsection*{Proof of \thmref{thm-eabsbool}}

\begin{derivation}
\step{\hasty{\cx,\vdecO}{\expr}{\bool}}{\hyp}
\step{\cxwf{\cx,\vdecO}}{\thmref{thm-cxwf}, 1}
\step{\cxwfO}{\thmref{thm-cxprefix}, 2}
\step{\istyO{\bool}}{\Rtbool, 3}
\step{\hastyO{\absO}{\tarr{\typ}{\bool}}}{\Reabs, 1, 4}
\end{derivation}
...
\step{\hastyO{\abs{\vaR}{\typ}{\vaR}}{\tarr{\typ}{\typ}}}{\Reabs, 3, 1}
...
derive $\hastyO{\abs{\var}{\bool}{(\eq{\var}{\false})}}{\tarr{\bool}{\bool}}$,
...
\step{\hastyO{\app{\faopO}{(\absO)}}{\bool}}{\Reapp, 7, 5}
\end{derivation}
...
\step{\hasty{\cx,\vdec{\varFXpred}{\tarr{\typ}{\bool}}}
            {\exopO}{\tarr{(\tarr{\typ}{\bool})}{\bool}}}
     {\Reexop, 6}
\step{\isty{\cx,\vdec{\varFXpred}{\tarr{\typ}{\bool}}}{\bool}}
     {\Rtbool, 5}
\step{\hasty{\cx,\vdec{\varFXpred}{\tarr{\typ}{\bool}}}
            {\abs{\varFX}{\typ}
                 {(\conj{\app{\varFXpred}{\varFX}}
...
\begin{derivation}
\step{\hasty{\cx,\vdecO}{\expr}{\bool}}{\hyp}
\step{\hastyO{\absO}{\tarr{\typ}{\bool}}}{\Reabsbool, 1}
...
\step{\istyO{\tarr{\typ}{\typ_1}}}{\Rtarr, 5, 2}
\step{\istyO{\tarr{\typ}{\typ_2}}}{\Rtarr, 5, 3}
\step{\cxwfO}{\thmref{thm-cxwf}, 5}
\end{derivation}
...
\step{\hasty{\cx,\vdec{\varI}{\tarr{\typ}{\typ_2}},\vdec{\varI'}{\typ}}
     ...
     {\Reapp, 15, 14}
\step{\isty{\cx,\vdec{\varI}{\tarr{\typ}{\typ_2}}}{\bool}}
     {\Rtbool, 9}
...
{\cvarv{\app{\tspred}{(\app{\varI}{\varI'})}}{\varI'}
 ...
 \link{=}{\thmref{thm-esbs-not-free}, 19, \defof{\cvarvY}}
 \emptyset}
...
\begin{derivatioN}{5}
\step{\cxwf{\cx,\vdec{\varI}{\trec{i}{\fnam_i}{\typ_i'}}}}{\Rcxvdec, 2, 5}
...
\step{\cxwf{\cx,\vdecO}}{\thmref{thm-cxwf}, 2}
\step{\istyO{\typ}}{\thmref{thm-var-type-wf}, 3}
\step{\istyO{\tarr{\typ}{\typ'}}}{\Rtarr, 4, 1}
\end{derivation}
...
\Case{\ReifO}
\begin{derivation}
\step{\hastyO{\expr_1}{\typ}}{\premof{\ReifO}}
...
\step{\istyO{\tarr{\tsub{(\tarr{\typ}{\bool})}{\exIopO}}{\typ}}}{\Rtarr, 4, 1}
\end{derivation}
...
\step{\istyO{\tarr{\trecO}{\typ_j}}}{\Rtarr, 1, 2}
\end{derivation}
