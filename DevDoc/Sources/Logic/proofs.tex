...
\Case{\Rcxmt}\\
We have $\catII{\cx_1}{\cx_2}=\cx_1=\cx_2=\seqO$ and $\cxwf{\seqO}$ by \Rcxmt.

\Case{\Rcxtdec, \Rcxtvdec, \Rcxodec, \Rcxvdec, \Rcxax}\\
If $\cx_2=\seqO$, the (first) implication is trivially proved. If instead
$\cx_2\neq\seqO$, we have $\cx_2=\snoc{\cx_2'}{\cxel}$ for some $\cx_2'$ and
$\cxel$ and the rule has either a premise of the form
$\cxwf{\catII{\cx_1}{\cx_2'}}$ or a premise of the form
$\jcxdots{\catIII{\cx_1}{\cx_2'}{\cx_3}}$ for some $\cx_3$ (possibly
$\cx_3=\seqO$); thus, by induction hypothesis we have $\cxwf{\cx_1}$.

\Case{\restrules}\\
The rule has either a premise of the form $\cxwf{\catII{\cx_1}{\cx_2}}$ or a
premise of the form $\jcxdots{\catIII{\cx_1}{\cx_2}{\cx_3}}$ for some $\cx_3$
(possibly $\cx_3=\seqO$). Thus, by induction hypothesis we have $\cxwf{\cx_1}$.
...
\step{\cxwf{\snoc{\cx_1}{\tdecO}}}{\thmref{thm-cxwf}, 1}
\step{\tnam\not\in\cxtnam{\cx_1}}
     {\premof{\Rcxtdec}, only rule that can derive 2}
\end{derivation}
Consider $\tnam'\in\cxtnam{\cx_2}$:
\begin{derivatioN}{3}
\steP{\EXISTS{\cx_2',\cx_2'',n'}{\cx_2=\cx_2',\tdec{\tnam'}{n'},\cx_2''}}
\step{\cxwf{\cx_1,\tdecO,\cx_2',\tdec{\tnam'}{n'}}}{1, 4, \thmref{thm-cxwf}}
...
\step{\cxwf{\snoc{\cx_1}{\odecO}}}{\thmref{thm-cxwf}, 1}
...
\subsection*{Proof of \thmref{thm-free-var-expr-in-cx}}

By induction on the derivation of the judgement in the antecedent of the
implication:
...
\step{\efvar{\expr}\subseteq\cxvar{\snoc{\cx}{\vdecO}}}{\indhyp, 1}
\step{\efvar{\expr}\subseteq\cxvarO\cup\setI{\var}}{2}
\step{\efvar{\expr}-\setI{\var}\subseteq\cxvarO-\setI{\var}}{3}
\step{\cxwf{\snoc{\cx}{\vdecO}}}{\thmref{thm-cxwf}, 1}
\step{\var\not\in\cxvarO}{\thmref{thm-cx-uniq-var}, 5}
\step{\cxvarO-\setI{\var}=\cxvarO}{6}
\step{\efvar{\absO}\subseteq\cxvarO}{4, 7}
\end{derivation}
...
\subsection*{Proof of \thmref{thm-free-var-ax-in-cx}}

\begin{derivation}
\step{\cxwf{\snocons{\cx_1}{\axO}{\cx_2}}}{\hyp}
\step{\hasty{\snoc{\cx_1}{\tvdec{\tvarS}}}{\expr}{\bool}}{\thmref{thm-ax-wt}, 1}
\step{\efvar{\expr}\subseteq\cxvar{\cx_1}}{\thmref{thm-free-var-expr-in-cx}, 2}
\end{derivation}



\subsection*{Proof of \thmref{thm-free-var-thm-in-cx}}
...
\step{\efvar{\expr}\subseteq\cxvar{\cx_1}}{\thmref{thm-free-var-ax-in-cx}, 2, 3}
...
\step{\efvar{\app{(\absO)}{\expr'}}\subseteq\cxvarO}
     {\thmref{thm-free-var-expr-in-cx}, 2}
...
\step{\efvar{\expr}\subseteq\cxvarO}{\thmref{thm-free-var-expr-in-cx}, 2}
...
$\efvar{\expr}\subseteq\cxvarO$. The conclusion $\theo{\cx}{\expr}$ of the other
rules is such that every variable in $\efvar{\expr}$ is also in $\efvar{\expr'}$
for some $\expr'$ that occurs in a premise $\hastyany{\cx'}{\expr'}$ or
$\theo{\cx'}{\expr'}$ of the rule such that $\cxvar{\cx'}=\cxvarO$, which proves
$\efvar{\expr}\subseteq\cxvarO$ by \thmref{thm-free-var-expr-in-cx} or by
induction hypothesis (the only rules for which $\cx'\neq\cx$ are \Rthifsbs\ and
\Rthif, where $\cx'=\snoc{\cx}{\axM{\ldots}}$ and so clearly
$\cxvar{\cx'}=\cxvarO$).
...
\Case{\Rcxmt}\\
This rule is impossible because $\snocons{\cx_1}{\cxel}{\cx_2}\neq\mtcx$.

\Case{\Rcxtdec}\\
If $\cx_2\neq\mtcx$:
\begin{derivation}
\steP{\EXISTS{\cx_2',\tnam,n}{\cx_2=\snoc{\cx_2'}{\tdecO}}}
\step{\cxwf{\snocons{\cx_1}{\cxel}{\cx_2'}}}{\premof{\Rcxtdec}, 1}
...
If $\cx_2\neq\mtcx$:
\begin{derivation}
\steP{\EXISTS{\cx_2',\onam,\tvarS,\typ}{\cx_2=\snoc{\cx_2'}{\odecO}}}
\step{\isty{\snoc{\snocons{\cx_1}{\cxel}{\cx_2'}}{\tvdec{\tvarS}}}{\typ}}
     {\premof{\Rcxodec}, 1}
\step{\cxwf{\snoc{\snocons{\cx_1}{\cxel}{\cx_2'}}{\tvdec{\tvarS}}}}
     {\thmref{thm-cxwf}, 2}
\step{\cxtvar{\cx_1}\supseteq\ftvar{\cxel}}{\indhyp, 3}
\end{derivation}
...
\Case{\Rcxvdec}\\
If $\cx_2\neq\mtcx$, the proof is analogous to \Rcxodec.
...
\step{\fresh{\varI'}}{\hyp}
\step{\varI'\not\in\cxvar{\cx_1}}{2}
\step{\cxwf{\snoc{\cx_1}{\vdec{\varI'}{\typ}}}}{\Rcxvdec, 1, 3}
\end{derivation}
\noindent
...
\step{\var\not\in\cxvar{\cx_1}}{1, 2}
\step{\cxvar{\cx_2}=\cxvar{\esbsren{\cx_2}}}{\thmref{thm-esbs-cx-decl}}
\step{\var\not\in\cxvar{\esbsren{\cx_2}}}{1, 2, 4}
\step{\fresh{\varI'}}{\hyp}
\step{\var\neq\varI'}{6}
\steP{\cxvar{\cxvI}=\cxvar{\cx_1}\cup\setI{\varI'}\cup\cxvar{\esbsren{\cx_2}}}
\step{\var\not\in\cxvar{\cxvI}}{8, 3, 7, 5}
\step{\isty{\cxv}{\typ}}{0}
\step{\isty{\cxvI}{\typ}}{10, \indhyp}
\step{\cxwf{\snoc{\cxvI}{\vdecO}}}{\Rcxvdec, 11, 9}
\end{derivation}
...
\step{\efvar{\expr}\subseteq\cxvar{\cx_1'}}
     {\thmref{thm-free-var-expr-in-cx}, 8}
...
If $\var\not\in\cxvar{\cx'}$:
\begin{derivatioN}{5}
\step{\cxwf{\snoc{\cx'}{\vdec{\var}{\typ_1}}}}{\Rcxvdec, 4}
\step{\snoc{\cx}{\vdec{\var}{\typ_1}}\subseteq\snoc{\cx'}{\vdec{\var}{\typ_1}}}
     {5}
\step{\isty{\snoc{\cx'}{\vdec{\var}{\typ_1}}}{\typ_2}}{\indhyp, 6, 7, 1}
\step{\isty{\cx'}{\tarrO}}{\Rtarr, 8}
\end{derivatioN}
...
\step{\snoc{\cx}{\vdec{\var'}{\typ_1}}\subseteq
     ...
     {5}
\step{\isty{\snoc{\cx'}{\vdec{\var'}{\typ_1}}}{\typ_2}}{\indhyp, 7, 8, 6}
...
If $\var\not\in\cxvar{\cx'}$:
\begin{derivatioN}{7}
\step{\cxwf{\snoc{\cx'}{\vdec{\var}{\typ}}}}{\Rcxvdec, 4}
...
\step{\issub{\snoc{\cx}{\vdec{\varI}{\typ}}}{\typ_1}{\tspred}{\typ_2}}
     {\thmref{thm-deriv-rename-var}, 1}
\step{\cxwf{\snoc{\cx'}{\vdec{\varI}{\typ}}}}{\Rcxvdec, 4}
\step{\snoc{\cx}{\vdec{\varI}{\typ}}\subseteq\snoc{\cx'}{\vdec{\varI}{\typ}}}{5}
\step{\issub{\snoc{\cx'}{\vdec{\varI}{\typ}}}{\typ_1}{\tspred}{\typ_2}}
     {\indhyp, 9, 10, 8}
\step{\issub{\cx'}{\tarr{\typ}{\typ_1}}{\tspred'}{\tarr{\typ}{\typ_2}}}
     {\Rstarr, 11, 6, 7}
...
If $\var\not\in\cxvar{\cx'}$:
\begin{derivatioN}{5}
\step{\cxwf{\snoc{\cx'}{\vdecO}}}{\Rcxvdec, 4}
\step{\snoc{\cx}{\vdecO}\subseteq\snoc{\cx'}{\vdecO}}{5}
\step{\hasty{\cx',\vdecO}{\expr}{\typ'}}{\indhyp, 1, 6, 7}
\step{\hasty{\cx'}{\abs{\var}{\typ}{\expr}}{\tarr{\typ}{\typ'}}}{\Reabs, 8}
\end{derivatioN}
If $\var\in\cxvar{\cx'}$, pick a fresh variable $\var'$:
\begin{derivatioN}{5}
\step{\hasty{\cx,\vdec{\var'}{\typ}}{\esbs{\expr}{\var}{\var'}}{\typ'}}
     {\thmref{thm-deriv-rename-var}, 1}
\step{\cxwf{\snoc{\cx'}{\vdec{\var'}{\typ}}}}{\Rcxvdec, 4}
\step{\snoc{\cx}{\vdec{\var'}{\typ}}\subseteq\snoc{\cx'}{\vdec{\var'}{\typ}}}{5}
...
\step{\isty{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS}}
     ...
     {\indhyp, 3}
\step{\var\not\in\cxvar{\snocons{\cx_1}{\tvdec{\tvarIS}}{\cx_3}}}
     {\thmref{thm-cx-uniq-var}, 2}
\end{derivation}
If $\var\not\in\cxvar{\cx_2}$:
\begin{derivatioN}{5}
...
\step{\tsbslashok{\snoc{\cx_3}{\vdec{\var}{\typ_1}}}{\tvarIS}{\typIS}}
     {8, \hyp\ $\tsbslashok{\cx_3}{\tvarIS}{\typIS}$}
\step{\isty{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS},
            \vdec{\var}{\tsbslash{\typ_1}{\tvarIS}{\typIS}}}
...
\Case{\Rstarr}\\
Let the instance of \Rstarr\ used to derive the judgement be
\[
\rruleIII
 {\issub{\cx_1,\tvdec{\tvarIS},\cx_3,\vdecO}{\typ_1}{\tspred}{\typ_2}}
 {\var'\neq\var''}
 {\tspred'=\abs{\var'}
               {\tarr{\typ}{\typ_2}}
               {\fa{\var''}{\typ}{\app{\tspred}{(\app{\var'}{\var''})}}}}
 {\issub{\cx_1,\tvdec{\tvarIS},\cx_3}
        {\tarr{\typ}{\typ_1}}{\tspred'}{\tarr{\typ}{\typ_2}}}
 {0}
\]
The judgement
...
\begin{derivation}
\step{\issub{\cx_1,\tvdec{\tvarIS},\cx_3,\vdecO}{\typ_1}{\tspred}{\typ_2}}{0}
\step{\cxwf{\cx_1,\tvdec{\tvarIS},\cx_3,\vdecO}}{\thmref{thm-cxwf}, 1}
\step{\isty{\cx_1,\tvdec{\tvarIS},\cx_3}{\typ}}{\thmref{thm-var-type-wf}}
\step{\isty{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS}}
...
\step{\tvarIS\cap\cxtvar{\cx_3}=\emptyset}{8}
\step{\tvarIS\cap
      \cxtvar{\snoc{\cx_3}{\vdec{\var}{\tsbslash{\typ}{\tvarIS}{\typIS}}}}
      =\emptyset}
     {9}
\step{\FORALL{i}{\ftvar{\typI_i}\cap\ctvar{\cx_3}{\tvarI_i}=\emptyset}}{8}
...
\step{\tsbslashok{(\snoc{\cx_3}{\vdec{\var}{\tsbslash{\typ}{\tvarIS}{\typIS}}})}
                 {\tvarIS}{\typIS}}
     {10, 13}
\step{\issub{\snoc{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS}}
                  {\vdec{\var}{\tsbslash{\typ}{\tvarIS}{\typIS}}}}
            {\tsbslash{\typ_1}{\tvarIS}{\typIS}}
...
\step{\tspred'=\abs{\var'}
                   {\tarr{\typ}{\typ_2}}
                   {\fa{\var''}{\typ}{\app{\tspred}{(\app{\var'}{\var''})}}}}{0}
\step{\tsbslash{\tspred'}{\tvarIS}{\typIS}=
      \abs{\var'}
          {\tarr{\tsbslash{\typ}{\tvarIS}{\typIS}}
                {\tsbslash{\typ_2}{\tvarIS}{\typIS}}}
          {\fa{\var''}{\tsbslash{\typ}{\tvarIS}{\typIS}}
              {\app{\tsbslash{\tspred}{\tvarIS}{\typIS}}
                   {(\app{\var'}{\var''})}}}}
     {17, \thmref{thm-tsbs-abbrev}}
\step{\issub{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS}}
            {\tarr{\tsbslash{\typ}{\tvarIS}{\typIS}}
                  {\tsbslash{\typ_1}{\tvarIS}{\typIS}}}
            {\tsbslash{\tspred'}{\tvarIS}{\typIS}}
            {\tarr{\tsbslash{\typ}{\tvarIS}{\typIS}}
     ...
     {\Rstarr, 15, 16, 18}
\step{\issub{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS}}
            {\tsbslash{(\tarr{\typ}{\typ_1})}{\tvarIS}{\typIS}}
            {\tsbslash{\tspred'}{\tvarIS}{\typIS}}
            {\tsbslash{(\tarr{\typ}{\typ_2})}{\tvarIS}{\typIS}}}
     {19}
\end{derivatioN}
If $\var\in\cxvar{\cx_2}$, pick a fresh variable $\varI$:
\begin{derivatioN}{5}
\step{\issub{\snoc{\cx_1,\tvdec{\tvarIS},\cx_3}{\vdec{\varI}{\typ}}}
            {\typ_1}{\tspred}{\typ_2}}
     {\thmref{thm-deriv-rename-var}, 1}
\stepL{\issub{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS}}
             {\tsbslash{(\tarr{\typ}{\typ_1})}{\tvarIS}{\typIS}}
             {\tsbslash{\tspred'}{\tvarIS}{\typIS}}
             {\tsbslash{(\tarr{\typ}{\typ_2})}{\tvarIS}{\typIS}}}
      {analogous derivation as 6--20 above for case $\var\not\in\cxvar{cx_2}$}
\end{derivatioN}
...
\step{\tsbslashok{(\snoc{\cx_3}{\vdec{\var}{\tsbslash{\typ}{\tvarIS}{\typIS}}})}
                 {\tvarIS}{\typIS}}
     {10, 13}
\step{\hasty{\snoc{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS}}
                  {\vdec{\var}{\tsbslash{\typ}{\tvarIS}{\typIS}}}}
...
\stepL{\hasty{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS}}
             ...
             {\tarr{\tsbslash{\typ}{\tvarIS}{\typIS}}
                   {\tsbslash{\typ'}{\tvarIS}{\typIS}}}}
      {analogous derivation as 6--16 above for case $\var\not\in\cxvar{cx_2}$}
\step{\fresh{\var'}}{\hyp}
...
\step{\tsbslashok{\axM{\expr_0}}{\tvarIS}{\typIS}}{\defof{\tsbsokY}, 9}
\step{\tsbslashok{(\snoc{\cx_3}{\axM{\expr_0}})}{\tvarIS}{\typIS}}{8, 10}
\step{\hasty{\cx_1,\cx_2,\tsbslash{\cx_3}{\tvarIS}{\typIS},
             \axM{\tsbslash{\expr_0}{\tvarIS}{\typIS}}}
...
\Case{\restrules}\\
Analogous to \Rtbool: starting with the instance of the rule used to derive the
judgement in the antecedent of the implication, we replace $\tvdec{\tvarIS}$
with $\cx_2$ and $\tvarIS$ with $\typIS$ in the premises of the rule instance
and then we apply the rule to the transformed premises to obtain the conclusion
with $\tvarIS$ replaced with $\typIS$. We use \thmref{thm-tsbs-same-free-vars}
for \Rtsub. We use \thmref{thm-tsbs-abbrev} for \Rstrefl, \Rstrec, \Redesc,
\Rthbool, \Rthext, \Rthrec, and \Rthprojsub.  We use
\thmref{thm-tsbs-same-free-vars}, \thmref{thm-tsbs-same-capt-vars}, and
\thmref{thm-esbs-tsbs-comm} for \Reabsalpha.
...
\step{\cxwf{\cx,\cx',\vdecO}}{\Rcxvdec, 3, 4}
\end{derivation}
...
\begin{derivatioN}{1}
\step{\cxwf{\snoc{\cx}{\vdec{\var}{\typ_1}}}}{\Rcxvdec, 1}
\step{\istyO{\typ_2}}{\hyp}
...
\begin{derivation}
\step{\istyO{\typ}}{\hyp}
\step{\cxwf{\cx,\vdec{\vaR}{\typ}}}{\Rcxvdec, 1, \hyp\ $\vaR\not\in\cxvarO$}
...
\step{\istyO{\bool}}{\Rtbool, 2}
\step{\istyO{\tarr{\typ}{\bool}}}{\RtarrI, 1, 3}
\step{\cxwf{\cx,\vdec{\varFXpred}{\tarr{\typ}{\bool}}}}{\Rcxvdec, 4}
...
\begin{derivatioN}{5}
\step{\cxwf{\cx,\vdec{\varI}{\trec{i}{\fnam_i}{\typ_i'}}}}{\Rcxvdec, 5}
