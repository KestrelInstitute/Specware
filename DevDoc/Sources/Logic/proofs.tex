...
conclusion is a judgement of the form $(\jcxdots{\cx})$, except rules $\Rtarr$
and $\Reabs$, either have $\cxwfO$ as one of their premises, which immediately
proves $\cxwfO$, or have at least one premise of the form $(\jcxdots{\cx})$,
which proves $\cxwfO$ by induction hypothesis. Rules $\Rtarr$ and $\Reabs$
have premises of the form $(\jcxdots{\snoc{\cx}{\cxel}})$: we have
$\cxwf{\snoc{\cx}{\cxel}}$ by induction hypothesis and thus $\cxwfO$ by
\thmref{thm-cxprefix}.
...
\Case{\Rstarr}
\begin{derivation}
\step{\issubO{\typ_1}{\tspred}{\typ_2}}{\premofrule}
...
\Rthifsbs, \Rthif). We use \thmref{thm-ftvar-abbrev} for \Rstrefl, \Rstarr,
