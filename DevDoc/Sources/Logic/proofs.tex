...
re-statement of the theorem as opposed to the original statement is that the
re-statement can be proved by simple rule induction, while the original
...
mechanical proof in theorem provers such as HOL.}:
