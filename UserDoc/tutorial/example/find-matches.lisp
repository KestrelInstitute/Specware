       ...
       (if (consp ls) 
           (let ((pV101 (cdr ls))) 
             (return 
              (if ( =  i 0) 
                  pV101 
                  (LIST-SPEC::nthTail pV101 (INTEGER-SPEC::|!-| i 1))))))) 
...
(defun symb_matches? (s os) 
  (block 
   nil 
   (if (eq (car os) :|Some|) 
       (return (slang-built-in::slang-term-equals s (cdr os))) 
    ...
    (block 
     ...
     (if (null l1) 
         ...
         (if (consp l1) 
             (if (consp l2) 
                 (return 
                  (let ((pV22 (funcall comp (cons (car l1) (car l2))))) 
                    (block 
                     nil 
                     (if (eq (car pV22) :|Equal|) 
                         (return 
   ...
   (if (null s1) 
       ...
       (if (consp s1) 
           (let ((pV45 (cdr s1))
                 (pV44 (car s1))) 
             (return 
              (if (LIST-SPEC::|!member| pV44 s2) 
                  (LIST-SPEC::diff pV45 s2) 
                  (cons pV44 (LIST-SPEC::diff pV45 s2))))))) 
   ...
   (if (null l) 
       ...
       (if (consp l) 
           (let ((pV53 (cdr l))
             ...
             (return 
              (if (funcall f pV52) 
                  (cons pV52 (LIST-SPEC::filter-1-1 f pV53)) 
                  (LIST-SPEC::filter-1-1 f pV53)))))) 
  ...
  (block 
   ...
   (if (null l) 
       ...
       (if (consp l) 
           (let ((pV89 (cdr l))) 
             (return 
              (let ((pV84 (funcall f (car l)))) 
                (block 
                 nil 
                 (if (eq (car pV84) :|Some|) 
                     (return 
                      (cons (cdr pV84) (LIST-SPEC::mapPartial-1-1 f pV89))) 
                     (if (eq (car pV84) :|None|) 
                         (return (LIST-SPEC::mapPartial-1-1 f pV89)))) 
  ...
  (block 
   ...
   (if (null l) 
       ...
       (if (consp l) 
           (let ((pV111 (cdr l))
                 (pV110 (car l))) 
             (progn (if (null pV111) (return (funcall showElem pV110))) 
                    (return 
                     (STRING-SPEC::^ 
                      (STRING-SPEC::^ (funcall showElem pV110) sep) 
                      (LIST-SPEC::show-1-1-1 sep showElem pV111))))))) 
   (error "Nonexhaustive match failure in show")))
...
(defun OPTION::compare-1-1 (comp x) 
  (let ((pV120 (cons (car x) (cdr x)))) 
    (block 
     nil 
     (let ((pV122 (cdr pV120))
           (pV121 (car pV120))) 
       (if (eq (car pV121) :|None|) 
           (if (eq (car pV122) :|Some|) (return '(:|Less|))) 
           (if (eq (car pV121) :|Some|) 
               (if (eq (car pV122) :|Some|) 
                   (return (funcall comp (cons (cdr pV121) (cdr pV122)))) 
                   (if (eq (car pV122) :|None|) (return '(:|Greater|))))))) 
     (return '(:|Equal|)))))
