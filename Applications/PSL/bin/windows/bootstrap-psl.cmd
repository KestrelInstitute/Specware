...
%XEMACS%\i586-pc-win32\xemacs.exe -debug-init -l "%ALLEGRO%/xeli/fi-site-init" -l "%SPECWARE4%/Library/IO/Emacs/load"  -l "%SPECWARE4%/Applications/PSL/bin/windows/psl-init" -f "bootstrap-psl" &
