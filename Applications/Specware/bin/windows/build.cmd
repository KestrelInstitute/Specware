...
%XEMACS%\i586-pc-win32\xemacs.exe -debug-init -l "%ALLEGRO%/xeli/fi-site-init" -l "%SPECWARE4%/Library/IO/Emacs/load"  -l "%SPECWARE4%/Applications/Specware/bin/windows/specware-init" -f "build-specware" &
