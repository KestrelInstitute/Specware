...
(defun SPECWARE::saveSpecwareState (glob loc optUri validatedURIs)
...
(defun SPECWARE::restoreSavedSpecwareState
    (globalContext localContext optURI validatedURIs)
  (SPECWARE::restoreSavedSpecwareState-1
   (vector globalContext localContext optURI validatedURIs)))
