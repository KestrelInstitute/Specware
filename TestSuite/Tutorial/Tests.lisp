...
(test 
 ...
 ("Tutorial: MatchingProofs p1"
  ...
  :output '(";;; Elaborating obligator at $SPECWARE/UserDoc/tutorial/example/MatchingObligations#SymbolMatching_Oblig"
	    ...
	    "p1: Conjecture symb_matches?_Obligation_fn_precond in MatchingObligations#SymbolMatching_Oblig is Proved! using Snark in * seconds."
	    ""))
 ...
 ("Tutorial: MatchingProofs p2" 
  ...
  :output '(";;; Elaborating obligator at $SPECWARE/UserDoc/tutorial/example/MatchingObligations#WordMatching_Oblig"
	    ...
	    "p2: Conjecture word_matches_at?_Obligation_subsort in MatchingObligations#WordMatching_Oblig is Proved! using simple inequality reasoning."
	    ""))
 ...
 ("Tutorial: MatchingProofs p3" 
  ...
  :output '(";;; Elaborating proof-term at $SPECWARE/UserDoc/tutorial/example/MatchingProofs#p3"
	    ...
	    "p3: Conjecture word_matches_at?_Obligation_subsort0 in MatchingObligations#WordMatching_Oblig is Proved! using simple inequality reasoning."
	    ""))
 ...
 ("Tutorial: MatchingProofs p5"
  ...
  :output '(";;; Elaborating obligator at $SPECWARE/UserDoc/tutorial/example/MatchingObligations#WordMatching0_Oblig"
	    ...
	    "p5: Conjecture word_matches_at?_Obligation_subsort in MatchingObligations#WordMatching0_Oblig is Proved! using simple inequality reasoning*."
	    ""))
 ...
 ("Tutorial: MatchingProofs p8" 
  ...
  :output '(";;; Elaborating proof-term at $SPECWARE/UserDoc/tutorial/example/MatchingProofs#p8"
	    ...
	    "p8: Conjecture word_matches_aux?_Obligation_subsort in MatchingObligations#WordMatching0_Oblig is Proved! using Snark in * seconds."
	    ""))
 ...
 ("Tutorial: MatchingProofs p9" 
  ...
  :output '(";;; Elaborating proof-term at $SPECWARE/UserDoc/tutorial/example/MatchingProofs#p9"
	    ...
	    "p9: Conjecture word_matches_aux?_Obligation in MatchingObligations#WordMatching0_Oblig is Proved! using Snark in * seconds."
	    ""))
 ...
 ("Tutorial: MatchingProofs p10"
  ...
  :output '(";;; Elaborating proof-term at $SPECWARE/UserDoc/tutorial/example/MatchingProofs#p10"
	    ...
	    "p10: Conjecture word_matches_aux?_Obligation_fn_precond in MatchingObligations#WordMatching0_Oblig is Proved! using Snark in * seconds."
	    ""))
 ...
 ("Tutorial: MatchingProofs p12"
  ...
  :output '(";;; Elaborating obligator at $SPECWARE/UserDoc/tutorial/example/MatchingObligations#FindMatches0_Oblig"
	    ...
	    "p12: Conjecture find_matches_Obligation_fn_precond in MatchingObligations#FindMatches0_Oblig is Proved! using Snark in * seconds."
	    ""))
 ...
 ("Tutorial: MatchingProofs p13"
  ...
  :output '(";;; Elaborating proof-term at $SPECWARE/UserDoc/tutorial/example/MatchingProofs#p13"
	    ...
	    "p13: Conjecture find_matches_aux_Obligation_subsort in MatchingObligations#FindMatches0_Oblig is Proved! using simple inequality reasoning."
	    ""))
 ...
 ("Tutorial: MatchingProofs p14"
  ...
  :output '(";;; Elaborating proof-term at $SPECWARE/UserDoc/tutorial/example/MatchingProofs#p14"
	    ...
	    "p14: Conjecture find_matches_aux_Obligation in MatchingObligations#FindMatches0_Oblig is Proved! using Snark in * seconds."
	    ""))
 ...
 ("Tutorial: MatchingProofs p15"
  ...
  :output '(";;; Elaborating obligator at $SPECWARE/UserDoc/tutorial/example/MatchingObligations#FindMatches_Ref0_Oblig"
	    ...
	    "p15: Conjecture match_finding in MatchingObligations#FindMatches_Ref0_Oblig is Proved! using Snark in * seconds."
	    ""))
