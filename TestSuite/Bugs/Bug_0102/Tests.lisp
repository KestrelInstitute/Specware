...
(test 
 ...
 ("Bug 0102 : Extra variable in gnerated proof obligation [see test for 0101]"
  ...
  :output '(";;; Elaborating obligator at $TESTDIR/ObligationsOfInteger"
	    ...
	    "    ex1(minus : Functions.Bijection(Int, Int)) "
	    "     minus(0) = 0 "
	    "     && (fa(i : Int) (positive? i => minus i = ipred(minus(ipred i)))) "
	    "        && (fa(i_1 : Int) "
	    "             (negative? i_1 => minus i_1 = isucc(minus(isucc i_1))))"
	    " "
	    " op  - : Functions.Bijection(Int, Int) = "
	    "   the (minus : Functions.Bijection(Int, Int)) "
	    "    minus(zero) = zero "
	    "    && (fa(i : Int) (positive? i => minus i = ipred(minus(ipred i)))) "
	    "       && (fa(i : Int) "
	    ...
	    "  end-proof"
	    " "
	    " op  < ((i, j) : Int * Int) infixl 20 : Boolean = negative?(i - j)"
	    " "
	    " op  > ((i, j) : Int * Int) infixl 20 : Boolean = j < i"
	    " "
	    " op  <= ((i, j) : Int * Int) infixl 20 : Boolean = i < j || i = j"
	    " "
	    " op  >= ((i, j) : Int * Int) infixl 20 : Boolean = i > j || i = j"
	    " theorem Integer.<=_and_>=_are_converses is "
	    "    fa(i : Int, j : Int) i <= j = (j >= i)"
	    " type Nat = {i : Int | i >= 0}"
	    " conjecture Integer.induction_naturals_Obligation_subsort is "
	    "    fa(p : Nat -> Boolean, n : Nat) p(0) && p n => n + 1 >= 0"
	    " theorem Integer.induction_naturals is "
	    "    fa(p : Nat -> Boolean) "
	    "     p(0) && (fa(n : Nat) (p n => p(n + 1))) => (fa(n : Nat) p n)"
	    " "
	    " op  posNat? (n : Nat) : Boolean = n > 0"
	    " type PosNat = (Nat | posNat?)"
	    " conjecture Nat.succ_Obligation_subsort is fa(n : Nat) isucc n >= 0"
	    " "
	    " op  succ (n : Nat) : Nat = isucc n"
	    " conjecture Nat.pred_Obligation_subsort is fa(n : PosNat) ipred n >= 0"
	    " "
	    " op  pred (n : PosNat) : Nat = ipred n"
	    " conjecture Integer.sign_Obligation_subsort is "
	    "    fa(i : Int, s_1 : Int) "
	    ...
	    " type Int0 = {i : Int | i ~= 0}"
	    " "
	    " op  divides ((x, y) : Int * Int) infixl 20 : Boolean = ex(z : Int) x * z = y"
	    ...
	    "  end-proof"
	    " "
	    " op  multipleOf ((x, y) : Int * Int) infixl 20 : Boolean = y divides x"
	    " proof Isa -verbatim"
	    ...
	    " conjecture Integer.divT_examples_Obligation_subsort is "
	    "    14 divT 5 = 2 => 11 divT 5 = 2 => true"
	    " conjecture Integer.divT_examples_Obligation_subsort0 is "
	    "    14 divT 5 = 2 => 11 divT 5 = 2 => -(14) divT 5 = -(2) => true"
	    " conjecture Integer.divT_examples_Obligation_subsort1 is "
	    "    14 divT 5 = 2 "
	    "    => 11 divT 5 = 2 "
	    "       => -(14) divT 5 = -(2) => -(11) divT 5 = -(2) => -(5) ~= 0"
	    " conjecture Integer.divT_examples_Obligation_subsort2 is "
	    "    14 divT 5 = 2 "
	    "    => 11 divT 5 = 2 "
	    "       => -(14) divT 5 = -(2) "
	    "          => -(11) divT 5 = -(2) => 14 divT -(5) = -(2) => -(5) ~= 0"
	    " conjecture Integer.divT_examples_Obligation_subsort3 is "
	    "    14 divT 5 = 2 "
	    "    => 11 divT 5 = 2 "
	    "       => -(14) divT 5 = -(2) "
	    "          => -(11) divT 5 = -(2) "
	    "             => 14 divT -(5) = -(2) => 11 divT -(5) = -(2) => -(5) ~= 0"
	    " conjecture Integer.divT_examples_Obligation_subsort4 is "
	    "    14 divT 5 = 2 "
	    "    => 11 divT 5 = 2 "
	    "       => -(14) divT 5 = -(2) "
	    "          => -(11) divT 5 = -(2) "
	    ...
	    " conjecture Integer.modT_examples_Obligation_subsort is "
	    "    14 modT 5 = 4 => 11 modT 5 = 1 => true"
	    " conjecture Integer.modT_examples_Obligation_subsort0 is "
	    "    14 modT 5 = 4 => 11 modT 5 = 1 => -(14) modT 5 = -(4) => true"
	    " conjecture Integer.modT_examples_Obligation_subsort1 is "
	    "    14 modT 5 = 4 "
	    "    => 11 modT 5 = 1 "
	    "       => -(14) modT 5 = -(4) => -(11) modT 5 = -(1) => -(5) ~= 0"
	    " conjecture Integer.modT_examples_Obligation_subsort2 is "
	    "    14 modT 5 = 4 "
	    "    => 11 modT 5 = 1 "
	    "       => -(14) modT 5 = -(4) "
	    "          => -(11) modT 5 = -(1) => 14 modT -(5) = 4 => -(5) ~= 0"
	    " conjecture Integer.modT_examples_Obligation_subsort3 is "
	    "    14 modT 5 = 4 "
	    "    => 11 modT 5 = 1 "
	    "       => -(14) modT 5 = -(4) "
	    "          => -(11) modT 5 = -(1) "
	    "             => 14 modT -(5) = 4 => 11 modT -(5) = 1 => -(5) ~= 0"
	    " conjecture Integer.modT_examples_Obligation_subsort4 is "
	    "    14 modT 5 = 4 "
	    "    => 11 modT 5 = 1 "
	    "       => -(14) modT 5 = -(4) "
	    "          => -(11) modT 5 = -(1) "
	    ...
	    " conjecture Integer.divT_of_negated_divisor_Obligation_subsort is "
	    "    fa(j : Int0) - j ~= 0"
	    ...
	    " conjecture Integer.modT_of_negated_divisor_Obligation_subsort is "
	    "    fa(j : Int0) - j ~= 0"
	    ...
	    " conjecture Integer.divF_examples_Obligation_subsort is "
	    "    14 divF 5 = 2 => 11 divF 5 = 2 => true"
	    " conjecture Integer.divF_examples_Obligation_subsort0 is "
	    "    14 divF 5 = 2 => 11 divF 5 = 2 => -(14) divF 5 = -(3) => true"
	    " conjecture Integer.divF_examples_Obligation_subsort1 is "
	    "    14 divF 5 = 2 "
	    "    => 11 divF 5 = 2 "
	    "       => -(14) divF 5 = -(3) => -(11) divF 5 = -(3) => -(5) ~= 0"
	    " conjecture Integer.divF_examples_Obligation_subsort2 is "
	    "    14 divF 5 = 2 "
	    "    => 11 divF 5 = 2 "
	    "       => -(14) divF 5 = -(3) "
	    "          => -(11) divF 5 = -(3) => 14 divF -(5) = -(3) => -(5) ~= 0"
	    " conjecture Integer.divF_examples_Obligation_subsort3 is "
	    "    14 divF 5 = 2 "
	    "    => 11 divF 5 = 2 "
	    "       => -(14) divF 5 = -(3) "
	    "          => -(11) divF 5 = -(3) "
	    "             => 14 divF -(5) = -(3) => 11 divF -(5) = -(3) => -(5) ~= 0"
	    " conjecture Integer.divF_examples_Obligation_subsort4 is "
	    "    14 divF 5 = 2 "
	    "    => 11 divF 5 = 2 "
	    "       => -(14) divF 5 = -(3) "
	    "          => -(11) divF 5 = -(3) "
	    ...
	    " conjecture Integer.modF_examples_Obligation_subsort is "
	    "    14 modF 5 = 4 => 11 modF 5 = 1 => true"
	    " conjecture Integer.modF_examples_Obligation_subsort0 is "
	    "    14 modF 5 = 4 => 11 modF 5 = 1 => -(14) modF 5 = 1 => true"
	    " conjecture Integer.modF_examples_Obligation_subsort1 is "
	    "    14 modF 5 = 4 "
	    "    => 11 modF 5 = 1 => -(14) modF 5 = 1 => -(11) modF 5 = 4 => -(5) ~= 0"
	    " conjecture Integer.modF_examples_Obligation_subsort2 is "
	    "    14 modF 5 = 4 "
	    "    => 11 modF 5 = 1 "
	    "       => -(14) modF 5 = 1 "
	    "          => -(11) modF 5 = 4 => 14 modF -(5) = -(1) => -(5) ~= 0"
	    " conjecture Integer.modF_examples_Obligation_subsort3 is "
	    "    14 modF 5 = 4 "
	    "    => 11 modF 5 = 1 "
	    "       => -(14) modF 5 = 1 "
	    "          => -(11) modF 5 = 4 "
	    "             => 14 modF -(5) = -(1) => 11 modF -(5) = -(4) => -(5) ~= 0"
	    " conjecture Integer.modF_examples_Obligation_subsort4 is "
	    "    14 modF 5 = 4 "
	    "    => 11 modF 5 = 1 "
	    "       => -(14) modF 5 = 1 "
	    "          => -(11) modF 5 = 4 "
	    ...
	    " conjecture Integer.divF_of_negated_divisor_Obligation_subsort is "
	    "    fa(j : Int0) - j ~= 0"
	    ...
	    " conjecture Integer.modF_of_negated_divisor_Obligation_subsort is "
	    "    fa(j : Int0) - j ~= 0"
	    ...
	    " conjecture Integer.divC_examples_Obligation_subsort is "
	    "    14 divC 5 = 3 => 11 divC 5 = 3 => true"
	    " conjecture Integer.divC_examples_Obligation_subsort0 is "
	    "    14 divC 5 = 3 => 11 divC 5 = 3 => -(14) divC 5 = -(2) => true"
	    " conjecture Integer.divC_examples_Obligation_subsort1 is "
	    "    14 divC 5 = 3 "
	    "    => 11 divC 5 = 3 "
	    "       => -(14) divC 5 = -(2) => -(11) divC 5 = -(2) => -(5) ~= 0"
	    " conjecture Integer.divC_examples_Obligation_subsort2 is "
	    "    14 divC 5 = 3 "
	    "    => 11 divC 5 = 3 "
	    "       => -(14) divC 5 = -(2) "
	    "          => -(11) divC 5 = -(2) => 14 divC -(5) = -(2) => -(5) ~= 0"
	    " conjecture Integer.divC_examples_Obligation_subsort3 is "
	    "    14 divC 5 = 3 "
	    "    => 11 divC 5 = 3 "
	    "       => -(14) divC 5 = -(2) "
	    "          => -(11) divC 5 = -(2) "
	    "             => 14 divC -(5) = -(2) => 11 divC -(5) = -(2) => -(5) ~= 0"
	    " conjecture Integer.divC_examples_Obligation_subsort4 is "
	    "    14 divC 5 = 3 "
	    "    => 11 divC 5 = 3 "
	    "       => -(14) divC 5 = -(2) "
	    "          => -(11) divC 5 = -(2) "
	    ...
	    " conjecture Integer.modC_examples_Obligation_subsort is "
	    "    14 modC 5 = -(1) => 11 modC 5 = -(4) => true"
	    " conjecture Integer.modC_examples_Obligation_subsort0 is "
	    "    14 modC 5 = -(1) => 11 modC 5 = -(4) => -(14) modC 5 = -(4) => true"
	    " conjecture Integer.modC_examples_Obligation_subsort1 is "
	    "    14 modC 5 = -(1) "
	    "    => 11 modC 5 = -(4) "
	    "       => -(14) modC 5 = -(4) => -(11) modC 5 = -(1) => -(5) ~= 0"
	    " conjecture Integer.modC_examples_Obligation_subsort2 is "
	    "    14 modC 5 = -(1) "
	    "    => 11 modC 5 = -(4) "
	    "       => -(14) modC 5 = -(4) "
	    "          => -(11) modC 5 = -(1) => 14 modC -(5) = 4 => -(5) ~= 0"
	    " conjecture Integer.modC_examples_Obligation_subsort3 is "
	    "    14 modC 5 = -(1) "
	    "    => 11 modC 5 = -(4) "
	    "       => -(14) modC 5 = -(4) "
	    "          => -(11) modC 5 = -(1) "
	    "             => 14 modC -(5) = 4 => 11 modC -(5) = 1 => -(5) ~= 0"
	    " conjecture Integer.modC_examples_Obligation_subsort4 is "
	    "    14 modC 5 = -(1) "
	    "    => 11 modC 5 = -(4) "
	    "       => -(14) modC 5 = -(4) "
	    "          => -(11) modC 5 = -(1) "
	    ...
	    " conjecture Integer.divC_of_negated_divisor_Obligation_subsort is "
	    "    fa(j : Int0) - j ~= 0"
	    ...
	    " conjecture Integer.modC_of_negated_divisor_Obligation_subsort is "
	    "    fa(j : Int0) - j ~= 0"
	    ...
	    " conjecture Integer.divR_examples_Obligation_subsort is "
	    "    14 divR 5 = 3 => 11 divR 5 = 2 => true"
	    " conjecture Integer.divR_examples_Obligation_subsort0 is "
	    "    14 divR 5 = 3 => 11 divR 5 = 2 => -(14) divR 5 = -(3) => true"
	    " conjecture Integer.divR_examples_Obligation_subsort1 is "
	    "    14 divR 5 = 3 "
	    "    => 11 divR 5 = 2 "
	    "       => -(14) divR 5 = -(3) => -(11) divR 5 = -(2) => -(5) ~= 0"
	    " conjecture Integer.divR_examples_Obligation_subsort2 is "
	    "    14 divR 5 = 3 "
	    "    => 11 divR 5 = 2 "
	    "       => -(14) divR 5 = -(3) "
	    "          => -(11) divR 5 = -(2) => 14 divR -(5) = -(3) => -(5) ~= 0"
	    " conjecture Integer.divR_examples_Obligation_subsort3 is "
	    "    14 divR 5 = 3 "
	    "    => 11 divR 5 = 2 "
	    "       => -(14) divR 5 = -(3) "
	    "          => -(11) divR 5 = -(2) "
	    "             => 14 divR -(5) = -(3) => 11 divR -(5) = -(2) => -(5) ~= 0"
	    " conjecture Integer.divR_examples_Obligation_subsort4 is "
	    "    14 divR 5 = 3 "
	    "    => 11 divR 5 = 2 "
	    "       => -(14) divR 5 = -(3) "
	    "          => -(11) divR 5 = -(2) "
	    ...
	    " conjecture Integer.modR_examples_Obligation_subsort is "
	    "    14 modR 5 = -(1) => 11 modR 5 = 1 => true"
	    " conjecture Integer.modR_examples_Obligation_subsort0 is "
	    "    14 modR 5 = -(1) => 11 modR 5 = 1 => -(14) modR 5 = 1 => true"
	    " conjecture Integer.modR_examples_Obligation_subsort1 is "
	    "    14 modR 5 = -(1) "
	    "    => 11 modR 5 = 1 "
	    "       => -(14) modR 5 = 1 => -(11) modR 5 = -(1) => -(5) ~= 0"
	    " conjecture Integer.modR_examples_Obligation_subsort2 is "
	    "    14 modR 5 = -(1) "
	    "    => 11 modR 5 = 1 "
	    "       => -(14) modR 5 = 1 "
	    "          => -(11) modR 5 = -(1) => 14 modR -(5) = -(1) => -(5) ~= 0"
	    " conjecture Integer.modR_examples_Obligation_subsort3 is "
	    "    14 modR 5 = -(1) "
	    "    => 11 modR 5 = 1 "
	    "       => -(14) modR 5 = 1 "
	    "          => -(11) modR 5 = -(1) "
	    "             => 14 modR -(5) = -(1) => 11 modR -(5) = 1 => -(5) ~= 0"
	    " conjecture Integer.modR_examples_Obligation_subsort4 is "
	    "    14 modR 5 = -(1) "
	    "    => 11 modR 5 = 1 "
	    "       => -(14) modR 5 = 1 "
	    "          => -(11) modR 5 = -(1) "
	    ...
	    " conjecture Integer.divR_of_negated_divisor_Obligation_subsort is "
	    "    fa(j : Int0) - j ~= 0"
	    ...
	    " "
	    " op  euclidianDivision? ((i, j, q, r) : Int * Int0 * Int * Int) : Boolean = "
	    "   i = j * q + r && 0 <= r && r < abs j"
	    ...
	    " conjecture Integer.divE_examples_Obligation_subsort is "
	    "    14 divE 5 = 2 => 11 divE 5 = 2 => true"
	    " conjecture Integer.divE_examples_Obligation_subsort0 is "
	    "    14 divE 5 = 2 => 11 divE 5 = 2 => -(14) divE 5 = -(3) => true"
	    " conjecture Integer.divE_examples_Obligation_subsort1 is "
	    "    14 divE 5 = 2 "
	    "    => 11 divE 5 = 2 "
	    "       => -(14) divE 5 = -(3) => -(11) divE 5 = -(3) => -(5) ~= 0"
	    " conjecture Integer.divE_examples_Obligation_subsort2 is "
	    "    14 divE 5 = 2 "
	    "    => 11 divE 5 = 2 "
	    "       => -(14) divE 5 = -(3) "
	    "          => -(11) divE 5 = -(3) => 14 divE -(5) = -(2) => -(5) ~= 0"
	    " conjecture Integer.divE_examples_Obligation_subsort3 is "
	    "    14 divE 5 = 2 "
	    "    => 11 divE 5 = 2 "
	    "       => -(14) divE 5 = -(3) "
	    "          => -(11) divE 5 = -(3) "
	    "             => 14 divE -(5) = -(2) => 11 divE -(5) = -(2) => -(5) ~= 0"
	    " conjecture Integer.divE_examples_Obligation_subsort4 is "
	    "    14 divE 5 = 2 "
	    "    => 11 divE 5 = 2 "
	    "       => -(14) divE 5 = -(3) "
	    "          => -(11) divE 5 = -(3) "
	    ...
	    " conjecture Integer.modE_examples_Obligation_subsort is "
	    "    14 modE 5 = 4 => 11 modE 5 = 1 => true"
	    " conjecture Integer.modE_examples_Obligation_subsort0 is "
	    "    14 modE 5 = 4 => 11 modE 5 = 1 => -(14) modE 5 = 1 => true"
	    " conjecture Integer.modE_examples_Obligation_subsort1 is "
	    "    14 modE 5 = 4 "
	    "    => 11 modE 5 = 1 => -(14) modE 5 = 1 => -(11) modE 5 = 4 => -(5) ~= 0"
	    " conjecture Integer.modE_examples_Obligation_subsort2 is "
	    "    14 modE 5 = 4 "
	    "    => 11 modE 5 = 1 "
	    "       => -(14) modE 5 = 1 "
	    "          => -(11) modE 5 = 4 => 14 modE -(5) = 4 => -(5) ~= 0"
	    " conjecture Integer.modE_examples_Obligation_subsort3 is "
	    "    14 modE 5 = 4 "
	    "    => 11 modE 5 = 1 "
	    "       => -(14) modE 5 = 1 "
	    "          => -(11) modE 5 = 4 "
	    "             => 14 modE -(5) = 4 => 11 modE -(5) = 1 => -(5) ~= 0"
	    " conjecture Integer.modE_examples_Obligation_subsort4 is "
	    "    14 modE 5 = 4 "
	    "    => 11 modE 5 = 1 "
	    "       => -(14) modE 5 = 1 "
	    "          => -(11) modE 5 = 4 "
	    ...
	    " conjecture Integer.divE_of_negated_divisor_Obligation_subsort is "
	    "    fa(j : Int0) - j ~= 0"
	    ...
	    " conjecture Integer.divE_equals_divT_on_naturals_Obligation_subsort is "
	    "    fa(j : PosNat) posNat? j && j >= 0 => j ~= 0"
	    " conjecture Integer.divE_equals_divT_on_naturals_Obligation_subsort0 is "
	    "    fa(j : PosNat) posNat? j && j >= 0 => j ~= 0"
	    " theorem Integer.divE_equals_divT_on_naturals is "
	    "    fa(i : Nat, j : PosNat) i divE j = i divT j"
	    " conjecture Integer.divE_equals_divF_on_naturals_Obligation_subsort is "
	    "    fa(j : PosNat) posNat? j && j >= 0 => j ~= 0"
	    " conjecture Integer.divE_equals_divF_on_naturals_Obligation_subsort0 is "
	    "    fa(j : PosNat) posNat? j && j >= 0 => j ~= 0"
	    " theorem Integer.divE_equals_divF_on_naturals is "
	    "    fa(i : Nat, j : PosNat) i divE j = i divF j"
	    " conjecture Integer.div_Obligation_subsort is "
	    "    fa(j : PosNat) posNat? j && j >= 0 => j ~= 0"
	    " conjecture Integer.div_Obligation_subsort0 is "
	    "    fa(j : PosNat, i : Nat) i divE j >= 0"
	    " "
	    " op  div ((i, j) : Nat * PosNat) infixl 26 : Nat = i divE j"
	    " conjecture Integer.mod_Obligation_subsort is "
	    "    fa(j : PosNat) posNat? j && j >= 0 => j ~= 0"
	    " conjecture Integer.mod_Obligation_subsort0 is "
