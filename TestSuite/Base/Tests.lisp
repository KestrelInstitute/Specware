(test  ("(~ ( true )) = false" :swe "(~ ( true )) = false" :value '(:|Bool| . T))
       ...
       ("(or ( false , false )) = false" :swe "(or ( false , false )) = false" :value '(:|Bool| . T))
       ("let A = id ( false , false ) in (or A) = false" :swe "let A = id ( false , false ) in (or A) = false" :value '(:|Bool| . T))
       ("(or ( false , true )) = true" :swe "(or ( false , true )) = true" :value '(:|Bool| . T))
       ("let A = id ( false , true ) in (or A) = true" :swe "let A = id ( false , true ) in (or A) = true" :value '(:|Bool| . T))
       ("(or ( true , false )) = true" :swe "(or ( true , false )) = true" :value '(:|Bool| . T))
       ("let A = id ( true , false ) in (or A) = true" :swe "let A = id ( true , false ) in (or A) = true" :value '(:|Bool| . T))
       ("(or ( true , true )) = true" :swe "(or ( true , true )) = true" :value '(:|Bool| . T))
       ("let A = id ( true , true ) in (or A) = true" :swe "let A = id ( true , true ) in (or A) = true" :value '(:|Bool| . T))
       ...
       ("(lt ( \"\" , \"\" )) = false" :swe "(lt ( \"\" , \"\" )) = false" :value '(:|Bool| . T))
       ("let A = id ( \"\" , \"\" ) in (lt A) = false" :swe "let A = id ( \"\" , \"\" ) in (lt A) = false" :value '(:|Bool| . T))
       ("(lt ( \"\" , \"1\" )) = true" :swe "(lt ( \"\" , \"1\" )) = true" :value '(:|Bool| . T))
       ("let A = id ( \"\" , \"1\" ) in (lt A) = true" :swe "let A = id ( \"\" , \"1\" ) in (lt A) = true" :value '(:|Bool| . T))
       ("(lt ( \"0\" , \"1\" )) = true" :swe "(lt ( \"0\" , \"1\" )) = true" :value '(:|Bool| . T))
       ("let A = id ( \"0\" , \"1\" ) in (lt A) = true" :swe "let A = id ( \"0\" , \"1\" ) in (lt A) = true" :value '(:|Bool| . T))
       ("(lt ( \"09\" , \"1\" )) = true" :swe "(lt ( \"09\" , \"1\" )) = true" :value '(:|Bool| . T))
       ("let A = id ( \"09\" , \"1\" ) in (lt A) = true" :swe "let A = id ( \"09\" , \"1\" ) in (lt A) = true" :value '(:|Bool| . T))
       ("(lt ( \"1\" , \"\" )) = false" :swe "(lt ( \"1\" , \"\" )) = false" :value '(:|Bool| . T))
       ("let A = id ( \"1\" , \"\" ) in (lt A) = false" :swe "let A = id ( \"1\" , \"\" ) in (lt A) = false" :value '(:|Bool| . T))
       ("(lt ( \"1\" , \"1\" )) = false" :swe "(lt ( \"1\" , \"1\" )) = false" :value '(:|Bool| . T))
       ("let A = id ( \"1\" , \"1\" ) in (lt A) = false" :swe "let A = id ( \"1\" , \"1\" ) in (lt A) = false" :value '(:|Bool| . T))
       ("(lt ( \"10\" , \"1\" )) = false" :swe "(lt ( \"10\" , \"1\" )) = false" :value '(:|Bool| . T))
       ("let A = id ( \"10\" , \"1\" ) in (lt A) = false" :swe "let A = id ( \"10\" , \"1\" ) in (lt A) = false" :value '(:|Bool| . T))
       ("(lt ( \"2\" , \"1\" )) = false" :swe "(lt ( \"2\" , \"1\" )) = false" :value '(:|Bool| . T))
       ("let A = id ( \"2\" , \"1\" ) in (lt A) = false" :swe "let A = id ( \"2\" , \"1\" ) in (lt A) = false" :value '(:|Bool| . T))
       ;; String [115]:  op leq infixl 20 : String * String -> Boolean
       ("(leq ( \"\" , \"\" )) = true" :swe "(leq ( \"\" , \"\" )) = true" :value '(:|Bool| . T))
       ("let A = id ( \"\" , \"\" ) in (leq A) = true" :swe "let A = id ( \"\" , \"\" ) in (leq A) = true" :value '(:|Bool| . T))
       ("(leq ( \"\" , \"1\" )) = true" :swe "(leq ( \"\" , \"1\" )) = true" :value '(:|Bool| . T))
       ("let A = id ( \"\" , \"1\" ) in (leq A) = true" :swe "let A = id ( \"\" , \"1\" ) in (leq A) = true" :value '(:|Bool| . T))
       ("(leq ( \"0\" , \"1\" )) = true" :swe "(leq ( \"0\" , \"1\" )) = true" :value '(:|Bool| . T))
       ("let A = id ( \"0\" , \"1\" ) in (leq A) = true" :swe "let A = id ( \"0\" , \"1\" ) in (leq A) = true" :value '(:|Bool| . T))
       ("(leq ( \"09\" , \"1\" )) = true" :swe "(leq ( \"09\" , \"1\" )) = true" :value '(:|Bool| . T))
       ("let A = id ( \"09\" , \"1\" ) in (leq A) = true" :swe "let A = id ( \"09\" , \"1\" ) in (leq A) = true" :value '(:|Bool| . T))
       ("(leq ( \"1\" , \"\" )) = false" :swe "(leq ( \"1\" , \"\" )) = false" :value '(:|Bool| . T))
       ("let A = id ( \"1\" , \"\" ) in (leq A) = false" :swe "let A = id ( \"1\" , \"\" ) in (leq A) = false" :value '(:|Bool| . T))
       ("(leq ( \"1\" , \"1\" )) = true" :swe "(leq ( \"1\" , \"1\" )) = true" :value '(:|Bool| . T))
       ("let A = id ( \"1\" , \"1\" ) in (leq A) = true" :swe "let A = id ( \"1\" , \"1\" ) in (leq A) = true" :value '(:|Bool| . T))
       ("(leq ( \"10\" , \"1\" )) = false" :swe "(leq ( \"10\" , \"1\" )) = false" :value '(:|Bool| . T))
       ("let A = id ( \"10\" , \"1\" ) in (leq A) = false" :swe "let A = id ( \"10\" , \"1\" ) in (leq A) = false" :value '(:|Bool| . T))
       ("(leq ( \"2\" , \"1\" )) = false" :swe "(leq ( \"2\" , \"1\" )) = false" :value '(:|Bool| . T))
       ("let A = id ( \"2\" , \"1\" ) in (leq A) = false" :swe "let A = id ( \"2\" , \"1\" ) in (leq A) = false" :value '(:|Bool| . T))
